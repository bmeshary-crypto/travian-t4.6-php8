...
if (!isset($_GET['t']) || !is_numeric($_GET['t']) || $_GET['t'] > 5) {
    $_GET['t'] = 1;
}
?>
...
<body class="v35 webkit <?= $database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> ?> village1  perspectiveResources buildingsV3 <?php echo DIRECTION; ?> buildingsV3">
                ...
                <div id="contentOuterContainer" class="size1">
                    ...
                    <div class="contentContainer">
                        <div id="content" class="production">
                            <h1 class="titleInHeader">Overview On production</h1>
                                        ...
                                        <table cellspacing="1" cellpadding="1" class="row_table_data">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td>Woodcutter
                                                                level <?php echo $session->fData['f' . $i]; ?></td>
                                            ...
                                            <div class="fluidSpeechBubble">
                                                ...
                                                <div class="fluidSpeechBubble-contents cf">
                                                    <form id="fluidSpeechBubble" method="post" action="">
                                                        ...
                                                        <div>
                                                            <button type="button" class="gold  productionBoostButton wood" coins="50" id="buttonn6" onclick="">
                                                                <div class="button-container addHoverClick">
                                                                    ...
                                                                    <div class="button-content">فعل<img src="img/x.gif" class="goldIcon" alt=""><span class="goldValue">50</span></div>
                                                                </div>
                                                            </button>
                                                                ...
                                                                jQuery(function() {
                                                                    jQuery('#buttonn6').click(function(event) {
                                                                        jQuery(window).trigger('buttonClicked', [this, {
                                                                            ...
                                                                            "title": "\u062a\u0641\u0639\u064a\u0644 \u0627\u0644\u0622\u0646 &lt;br&gt; \u0645\u062f\u0629 \u0627\u0644\u0632\u064a\u0627\u062f\u0629 \u0623\u064a\u0627\u0645 &lt;span class=&quot;bold&quot;&gt;4&lt;\/span&gt; \u0627\u064a\u0627\u0645",
                                                                            "coins": 50,
                                                                            "id": "buttonn6"
                                                                        }]);
                                                                    });
                                                        ...
                                                        <div class="productionBoostSpeechBubbleFurtherInfo">
                                                            <p>تزد علاوة إنتاج From إنتاج مورد <span class="underlined">لكل</span>
                                                                قراكم.</p>
                                                        </div>
                                                    </form>
                                                </div>
                                                ...
                                                <div class="fluidSpeechBubble">
                                                    ...
                                                    <div class="fluidSpeechBubble-contents cf">
                                                        <form id="fluidSpeechBubble" method="post" action="">
                                                            ...
                                                            <div>
                                                                <button type="button" class="gold  productionBoostButton crop" coins="50" id="buttonU6" onclick="">
                                                                    <div class="button-container addHoverClick">
                                                                        <div class="button-background">
                                                                            <div class="buttonStart">
                                                                                <div class="buttonEnd">
                                                            ...
                                                            <div class="productionBoostSpeechBubbleFurtherInfo">
                                                                <p>Production Bonus Increases From Supplier Production
                                                                    <span class="underlined">All</span> your villages.
                                                                </p>
                                                            </div>
                                                        </form>
                                                    </div>
                                                        ...
                                                        <div class="switchDownContent">
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="troopLabel">
                                                                            - in a واحة أو reinforcementات From قرى Own
                                                                        </td>
                                                                        <td class="numberCell">0</td>
                                                                    </tr>
                                                                    <tr class=" inactive">
