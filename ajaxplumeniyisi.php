                ...
                case 'checkRecipient':
                    ...
                    if($usData['id'] || $uName = '[ally]; [ally]'){
                        ...
                        if($cIgnore != 0 && $session->access !=9 && $uName != '[ally]; [ally]'){
                            echo '{"response":{"error":true,"errorMsg":"Bu oyuncuya mesaj gönderemezsiniz, oyuncu sizi Kara Listeye ekledi","data":[]}}';
                        }else{
                            ...
                            if($totalpop < 100 && $session->access != 9){
                                echo '{"response":{"error":true,"errorMsg":"Nüfusunuz 100 den az ise mesaj gönderemezsiniz!","data":[]}}';
                            }else{
