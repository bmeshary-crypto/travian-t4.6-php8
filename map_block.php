...
//if(false){
    ...
    for ($i = 0; $i <= ($nob * $nob) - 1; $i++) {
        ...
        if ($maparray[$i]['zerodis'] <= $nareadis) {
            $maparray[$i]['isgraytile'] = true;
        } else {
        ...
        if ($maparray[$i]['isgraytile']) {
            if ($maparray[$i]['x'] == -1 && $maparray[$i]['y'] == 1) {
                $bgimgclass2 = ' 1';
            } elseif ($maparray[$i]['x'] == 0 && $maparray[$i]['y'] == 1) {
                $bgimgclass2 = ' 2';
            } elseif ($maparray[$i]['x'] == 1 && $maparray[$i]['y'] == 1) {
                $bgimgclass2 = ' 3';
            } elseif ($maparray[$i]['x'] == -2 && $maparray[$i]['y'] == 0) {
                $bgimgclass2 = ' 4';
            } elseif ($maparray[$i]['x'] == -1 && $maparray[$i]['y'] == 0) {
                $bgimgclass2 = ' 5';
                ...
                $bgimgclass2 = ' 8';
            } elseif ($maparray[$i]['x'] == -2 && $maparray[$i]['y'] == -1) {
                $bgimgclass2 = ' 9';
            } elseif ($maparray[$i]['x'] == -1 && $maparray[$i]['y'] == -1) {
                $bgimgclass2 = ' 10';
            } elseif ($maparray[$i]['x'] == 0 && $maparray[$i]['y'] == -1) {
                ...
                $bgimgclass2 = ' 13';
            } elseif ($maparray[$i]['x'] == -2 && $maparray[$i]['y'] == -2) {
                $bgimgclass2 = ' 14';
            } elseif ($maparray[$i]['x'] == -1 && $maparray[$i]['y'] == -2) {
                $bgimgclass2 = ' 15';
            } elseif ($maparray[$i]['x'] == 0 && $maparray[$i]['y'] == -2) {
                $bgimgclass2 = ' 16';
            } elseif ($maparray[$i]['x'] == 1 && $maparray[$i]['y'] == -2) {
                $bgimgclass2 = ' 17';
            } elseif ($maparray[$i]['x'] == 2 && $maparray[$i]['y'] == -2) {
...
//print_r($queue);die;
    foreach ($queue as $block) {
        ...
        if ($block[5] != 'tilespbgimg') {
            ...
            switch ($block[6]) {
                case 1:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 60, 0, $bw, $bh, 60, 60);
                    break;
                case 2:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 120, 0, $bw, $bh, 60, 60);
                    break;
                case 3:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 180, 0, $bw, $bh, 60, 60);
                    break;
                case 4:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 0, 60, $bw, $bh, 60, 60);
                    break;
                case 5:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 60, 60, $bw, $bh, 60, 60);
                    break;
                case 6:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 120, 60, $bw, $bh, 60, 60);

                    break;
                case 7:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 180, 60, $bw, $bh, 60, 60);
                    break;
                case 8:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 240, 60, $bw, $bh, 60, 60);
                    break;
                case 9:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 0, 120, $bw, $bh, 60, 60);
                    break;
                case 10:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 60, 120, $bw, $bh, 60, 60);
                    break;
                case 11:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 120, 120, $bw, $bh, 60, 60);
                    break;
                case 12:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 180, 120, $bw, $bh, 60, 60);
                    break;
                case 13:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 240, 120, $bw, $bh, 60, 60);
                    break;
                case 14:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 0, 180, $bw, $bh, 60, 60);
                    break;
                case 15:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 60, 180, $bw, $bh, 60, 60);
                    break;
                case 16:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 120, 180, $bw, $bh, 60, 60);
                    break;
                case 17:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 180, 180, $bw, $bh, 60, 60);
                    break;
                case 18:
                    imagecopyresized($img, imagecreatefrompng('img/m/volcano.png'), $x, $y, 240, 180, $bw, $bh, 60, 60);
                    break;
            }
        }
