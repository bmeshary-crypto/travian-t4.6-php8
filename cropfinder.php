...
<body class="v35 webkit <?=$database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> ar-AE cropfinder <?php if($dorf1==''){echo 'perspectiveBuildings';}else{ echo 'perspectiveResources';} ?> <?php echo DIRECTION; ?> buildingsV3">
...
<?php 
//include("application/views/res.php"); 
?>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>?s" method="post">
    <div class="boxes boxesColor gray" >
        ...
        <tr>
            ...
            <td><input type="radio" class="radio" name="type" value="15" <?php if($_POST['type'] == 15 ) { print 'checked="checked"'; } ?> /> 15<img src="<?=GP_LOCATION2 ?>x.gif" class="r4" alt="<?php echo CROP_COM; ?>" title="<?php echo CROP_COM; ?>" /></td>
            <td><input type="radio" class="radio" name="type" value="9" <?php if($_POST['type'] == 9) { print 'checked="checked"'; } ?> /> 9<img src="<?=GP_LOCATION2 ?>x.gif" class="r4" alt="<?php echo CROP_COM; ?>" title="<?php echo CROP_COM; ?>" /></td>
            <td><input type="radio" class="radio" name="type" value="both" <?php if($_POST['type'] == 'both') { print 'checked="checked"'; } ?> /> 15<img src="<?=GP_LOCATION2 ?>x.gif" class="r4" alt="<?php echo CROP_COM; ?>" title="<?php echo CROP_COM; ?>" />&9<img src="<?=GP_LOCATION2 ?>x.gif" class="r4" alt="<?php echo CROP_COM; ?>" title="<?php echo CROP_COM; ?>" /></td>
...
if($_POST['type'] == 15) {
    ?>
    <h4 class="round">دهکده های گندمی</h4>
