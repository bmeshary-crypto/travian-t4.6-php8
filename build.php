...
if ($_GET['id'] == 39 && $_GET['t'] == 2) {
    ...
    $ww = $village->natar;
    if ($_GET['id'] == 99 and $ww == 0 || $_GET['id'] != 99 && $_GET['id'] >= 43) {
        header("Location: dorf1.php");
        exit();
    }
    ...
    if ($session->goldclub == 1 && count($session->villages) > 1) {
        ...
        if (isset($_POST['action']) && $_POST['action'] == 'addRoute') {
            if (!in_array($_POST['tvillage'], $session->villages)) {
                die("You don't own this village...");
            }
...
<body class="v35 webkit <?= $database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> en-US build  <?php if ($dorf1 == '') {
                                                                                                    echo 'perspectiveBuildings';
                                                                                                } else {
                                                                                                    echo 'gidResources perspectiveResources';
            ...
            <div id="center">
                ...
                <div id="contentOuterContainer" class="size1">
                    ...
                    <div class="contentTitle">
                        ...
                        <a id="answersButton" class="contentTitleButton buttonFramed withIcon rectangle green" href="#">&nbsp;</a>
                    </div>

                    <div class="contentContainer">
                        <div id="content" class="<?php if ($_GET['id'] == 39 && $_GET['t'] == 2) {
                                                        echo 'a2b';
                                                    } else {
                                                        echo 'build';
                                                    } ?>">
                            ...
                            ?>
                                            <h1 class="titleInHeader"><?= $lang['buildings'][$village->resarray['f' . $_GET['id'] . 't']] ?>
                                            ...
                                            <div id="build" class="gid<?= $village->resarray['f' . $_GET['id'] . 't'] ?> level<?= $village->resarray['f' . $id] ?>">
                                                ...
                                                if (in_array($bid, array(16, 17, 25, 26, 27, 37, 44))) {
                                                    // TODO when favorActive was add for favor class, it means was set to favor, this action needs an api ajax.
                                                ...
                                                ?>
                                                    ...
                                                    <!--                            <div class="upgradeHeader levelSpecificInfo">-->
                                                    <!--                            </div>-->
                                    ...
                                    <?php
                                                    ...
                                                    // echo "include[application/views/Build/" . $village->resarray['f' . $_GET['id'] . 't'] . ".php]";
