...
<body class="v35 webkit <?= $database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> ar-AE village-2 <?php if ($dorf1 == '') {
    ...
    <div id="bodyWrapper">
        ...
        <div id="center">
            ...
            <div id="contentOuterContainer" class="size1">
                ...
                <div class="contentTitle"><a id="closeContentButton" class="contentTitleButton"
                                             href="dorf<?= $session->link ?>.php" title="Close window">&nbsp;</a>
                    ...
                    <div id="content" class="plus">
                        ...
                        <div id="content" class="village2" style="font-size: 9pt;">
                            ...
                            <p style="width:90%">
                                ...
                                <?= $lang_winner['3']; ?>
                                "<?php echo "<a href=\"karte.php?d=$vref&c=" . $generator->getMapCheck($vref) . "\">$winningvillagename</a>"; ?>
                                ", <?= $lang_winner['4']; ?>
                                <br/><br/>

                                <?= $lang_winner['5']; ?>
                                "<?php echo "<a href=\"allianz.php?aid=$allianceid\">$winningalliancetag</a>"; ?>",
                                "<?php echo "<a href=\"spieler.php?uid=$owner\">$username</a>"; ?>"
                                <?= $lang_winner['6']; ?>
                                "<?php echo "<a href=\"spieler.php?uid=$owner\">$username</a>"; ?>
                                " <?= $lang_winner['7']; ?><br/><br/>


                                "<a href="spieler.php?uid=<?php echo $datas[0]['userid']; ?>"
                                    title="<?= $lang_winner['desc1']; ?>: <?php echo $datas[0]['totalvillages'];
                                    echo "\n"; ?><?= $lang_winner['desc2']; ?>: <?php echo $datas[0]['totalpop']; ?>"><?php echo $datas[0]['username']; ?></a>" <?= $lang_winner['8']; ?>
                                "<a href="spieler.php?uid=<?php echo $datas[1]['userid']; ?>"
                                    title="<?= $lang_winner['desc1']; ?>: <?php echo $datas[1]['totalvillages'];
                                    echo "\n"; ?><?= $lang_winner['desc2']; ?>: <?php echo $datas[1]['totalpop']; ?>"><?php echo $datas[1]['username']; ?></a>" <?= $lang_winner['9']; ?>
                                "<a href="spieler.php?uid=<?php echo $datas[2]['userid']; ?>"
                                    title="Total Villages: <?php echo $datas[2]['totalvillages'];
                                    echo "\n"; ?>Total Population: <?php echo $datas[2]['totalpop']; ?>"><?php echo $datas[2]['username']; ?></a>".<br/>
                                "<a href="spieler.php?uid=<?php echo $attacker[0]['userid']; ?>"
                                    title="<?= $lang_winner['desc3']; ?>: <?php echo $attacker[0]['apall']; ?>"><?php echo $attacker[0]['username']; ?></a>" <?= $lang_winner['10']; ?>
                                <br/>
                                "<a href="spieler.php?uid=<?php echo $defender[0]['userid']; ?>"
                                    title="<?= $lang_winner['desc4']; ?>: <?php echo $defender[0]['dpall']; ?>"><?php echo $defender[0]['username']; ?></a>" <?= $lang_winner['11']; ?>
