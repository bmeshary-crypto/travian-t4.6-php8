...
?>
<body class="v35 webkit <?= $database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> en-US hero hero_inventory <?php if ($dorf1 == '') {
                ...
                <div class="contentContainer">
                    <div id="content" class="hero_inventory">
                        <h1 class="titleInHeader">
                            <?= $session->username ?> - <?php echo U0; ?> <?= LVL . "  " . $session->heroD['level'] ?>
                        </h1>
                        <?php
                        include_once("application/views/Hero/heroMenu.php");
                         include_once("application/views/hero_attr.php");
                        ...
                        <div id="bodyOptions">
                            <div id="hero_body_container">
                                <div id="hero_body">
                                    ...
                                    <img class="heroBodyImage heroBodyImage-<?php echo strtoupper(DIRECTION); ?>"
                                         src="<?= $database->heroBody($session->uid) ?>">
                                    <div class="clear"></div>
                                </div>
                                ...
                                <div id="hero_body_content">
                                    <div class="content gender_<?= $gender ?>">
                                        ...
                                        if ($gi['leftHand'] != 0) {
                                            ...
                                            $item = '';
                                            if (!$dis) {
                                                $item = '<a href="?inventory&leftHand">';
                                            }
                                        ...
                                        if ($gi['rightHand'] != 0) {
                                            ...
                                            $item = '';
                                            if (!$dis) {
                                                $item = '<a href="?inventory&rightHand">';
                                            }
                                ...
                                <div class="boxes-contents cf">
                                    <div id="itemsToSale"><?php
                                        ...
                                        <div class="market">
                                            ...
                                            <a class="sell arrow"
                                               href="hero_auction.php?action=sell"><?= herohero5 ?></a>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
