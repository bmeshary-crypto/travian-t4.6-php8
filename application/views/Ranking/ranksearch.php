        ...
        <div class="boxes boxesColor gray">
            ...
            <div class="boxes-contents w292">
                <table class="transparent">
                    ...
                    <tr>
                        <td>
                            <span><?php echo OVERVIEW4; ?><input type="text" class="text ra" maxlength="5" name="rank"
                                                                 value="<?php echo ($search == 0) ? $start : $search; ?>"/></span>
                        </td>
                        <td>
                            <span><?php echo OVERVIEW17; ?><input type="text" class="text name" maxlength="20"
                                                                  name="name" value="<?php if (!is_numeric($search)) {
                                    echo $search;
                                } ?>"/></span>
                        <td>
                            <input type="hidden" name="ft"
                                   value="r<?php echo isset($_GET['id']) ? $_GET['id'] : 1; ?>"/>
                            <button type="submit" value="search" name="search" id="btn_ok" class="green dynamic_img"
                                    src="img/x.gif">
