<div class="contentNavi tabNavi">
    <div class="container <?php if (!isset($_GET) || $_GET['id'] == 1) {
        echo "active";
    } else {
        echo "normal";
    } ?>">
    ...
    <div class="container <?php if ($_GET['id'] == 31) {
        echo "active";
    } else {
        echo "normal";
    } ?>">
    ...
    <div class="container <?php if ($_GET['id'] == 32) {
        echo "active";
    } else {
        echo "normal";
    } ?>">
    ...
    <div class="container <?php if ($_GET['id'] == 7) {
        echo "active";
    } else {
        echo "normal";
    } ?>">
