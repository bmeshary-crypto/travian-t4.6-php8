...
<thead>
	...
	<tbody class="hoverable">
                        ...
                        <tr class="hover">
		<td><img src="https://gpack.newtravian.com/gpack/0/travian_default/img/gods/deftroops.png" height="100"></td>
		<td>
			<b>+4800</b>
...
<span class="none"> (-1000 <img src="https://gpack.newtravian.com/gpack/0/travian_default/img/a/Favor.png" alt="Favour" height="15">) </span>	
    ...
    <tr>
		<td><img src="https://gpack.newtravian.com/gpack/0/travian_default/img/gods/cityprotection.png" height="100"></td>
		<td>
		...
		<td><b>-3000</b> <img src="https://gpack.newtravian.com/gpack/0/travian_default/img/a/Favor.png" alt="Favour" height="15"></td>
		<td>
            ...
            if($session->god == 3){
                                ...
                                ?>
<span class="none"> (-3000 <img src="https://gpack.newtravian.com/gpack/0/travian_default/img/a/Favor.png" alt="Favour" height="15">) </span>	
                                <?php
                                }
