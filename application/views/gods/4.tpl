...
<thead>
	...
	<tbody class="hoverable">
                        ...
                        <tr class="hover">
		<td><img src="https://gpack.newtravian.com/gpack/0/travian_default/img/gods/spy.png" height="100"></td>
		<td>
			<b>+4000</b>
		...
		<td>
            ...
            if($session->god == 4){
                                ...
                                ?>
                                    <form action="gods.php?id=6&&artemis=1" method="POST" onsubmit="return confirm('<?php if($session->lang == 'ar'){ echo 'Satın alma işlemini onaylıyor musunuz?'; }else{ echo 'Do you confirm the purchase?'; } ?>')"><input class="trav_buttons" type="submit" value="Buy"></form>
                                <?php
                                } else {
                                ?>
<span class="none"> (-1000 <img src="https://gpack.newtravian.com/gpack/0/travian_default/img/a/Favor.png" alt="Favour" height="15">) </span>	
                                <?php
                                    ...
                                    echo '<a href="gods.php" style="color:gray;"> Activate Artemis</a>';
                                }
                                ?>
