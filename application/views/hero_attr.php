        ...
        <div class="roundedCornersBox lightGreen">
            ...
            <div class="boxes-contents cf">
                ...
                <table cellspacing="0" cellpadding="0" class="transparent attributes noPointsToSet">
                    ...
                    <tr class="attribute experience tooltip"
                        title="<?php if ($session->heroD['level'] != 100) { ?><?= HEROI33 ?>||<?php echo HEROI31 . ' ';
                            echo($hero_levels[$session->heroD['level'] + 1] - $session->heroD['experience']); ?> <?= HEROI32 ?> <?php echo($session->heroD['level'] + 1); ?> <?php } else {
                            echo 'Maximum Level Reached';
                        } ?>.">
                        <td class="element attribName"><?php echo HEROI33; ?></td>
                        <td class="element current powervalue">
                            <span class="value"
                                  style="font-size: 11px;"><?php echo $session->heroD['experience']; ?></span>
                        </td>
                        <td class="element progress">
                            <div class="bar-bg">
					...
					<span class="speed tooltip">
						<?php echo $lang['Hero']['Speed']; ?>:<strong
                            id="heroSpeedValueNumber"><?php echo $session->heroD['speed'] * INCREASE_SPEED; ?></strong> <?php echo HEROI38; ?></span>
                        </td>
                        <td class="pointsText" colspan="4">
                            <div class="production tooltip"
                                 title="<?php echo HEROI43 ?>||<?php echo HEROI47; ?>&lt;br /&gt;&lt;span class=&quot;
            ...
            inсе ресурсы&quot; class=<?php if ($session->heroD['r0'] != 0) {
             ...
             &lrm;&amp;#x202d;&amp;#x202d;&amp;#x202c;&amp;#x202c;&lrm;&lt;/span&gt;">
							...
							<span class="value" style="font-size: 11px;"><?php if ($session->heroD['r0'] != 0) {
                                    echo number_format($rp);
                                } else {
                                    echo number_format($session->heroD['product'] * 10 * SPEED);
                                } ?></span>
            ...
            <div class="boxes-contents cf">
                ...
                <div class="attribute regenerate tooltip"
                    ...
                    <div class="element attributesHeadline">
                        <?php echo $lang['Hero']['Revive01']; ?> <a
                            href="karte.php?d=<?php echo $session->heroD['wref']; ?>"><?php echo $database->getVillage($session->heroD['wref'])['name']; ?></a>. <?php echo $lang['Hero']['Revive02']; ?>
                        <a href="karte.php?d=<?php echo $village->wid; ?>"><?php echo $village->vname; ?></a>.
                    </div>
                    ...
                    <div class="roundedCornersBox white">
                        ...
                        <div class="inlineIconList resourceWrapper">
                            <div class="inlineIcon resource"><i class="r1Big"></i><span
                                    class="value value"><?php echo $hero_t[$session->heroD['level']]['wood']; ?></span>
                            </div>
                            <div class="inlineIcon resource"><i class="r2Big"></i><span
                                    class="value value"><?php echo $hero_t[$session->heroD['level']]['clay']; ?></span>
                            </div>
                            <div class="inlineIcon resource"><i class="r3Big"></i><span
                                    class="value value"><?php echo $hero_t[$session->heroD['level']]['iron']; ?></span>
                            </div>
                            <div class="inlineIcon resource"><i class="r4Big"></i><span
                                    class="value value"><?php echo $hero_t[$session->heroD['level']]['crop']; ?></span>
                            </div>
                            <div class="inlineIcon resource"><i class="cropConsumptionBig"></i><span
                                    class="value value">6</span></div>

                        </div>
                        <div class="lineWrapper">
                            <div class="inlineIcon duration"><i class="clock_medium"></i><span
                                    class="value "><?php echo $generator->getTimeFormat(($hero_t[$session->heroD['level']]['time'] / SPEED * 1.5)); ?></span>
                            </div>

                            <button type="submit" value="Revive" name="save" id="save" class="green startTraining"
    ...
    <div class="roundedCornersBox">
        <h4>
            <div class="openCloseSwitchBar">
                <img alt="<?php echo $lang['Hero']['Attributes']; ?>" src="img/x.gif"
                     class="openedClosedSwitch switchOpened">
        ...
        <div class="heroPropertiesContent <?php if ($freepoints <= 0 && $session->qData['quest'] != 6) {
            echo 'hide';
        } ?>">
                ...
                <div class="resourcePick">
                    ...
                    <div class="resource r0">
                        <label for="resourceHero0">
                            ...
                            <i class="r0"></i>
                            <span class="current"> <?php if ($rp > 10000) {
                                    echo $rp / 1000;
                                    echo 'k';
                                } else {
                                    echo $rp;
                    ...
                    <div class="resource r1">
                        <label for="resourceHero1">
                            ...
                            <i class="r1"></i>
                            <span class="current"> <?php if (($session->heroD['product'] * 10 * SPEED) > 10000) {
                                    echo ($session->heroD['product'] * 10
                                            * SPEED) / 1000;
                                    echo 'k';
                                } else {
                                    echo $session->heroD['product'] * 10 * SPEED;
                                } ?></span>
                        </label>
                    </div>
            ...
            <div class="attribute attackBehaviour">
                ...
                <div class="options">
                    <input type="radio" class="radio" name="attackBehaviour" id="attackBehaviour"
                           value="hide" <?php if ($session->heroD['hide'] == 1) {
                        echo 'checked="checked"';
                    } ?>> <label for="attackBehaviourHide"><?= HEROI40 ?> </label><br/>
                    <input type="radio" class="radio" name="attackBehaviour" id="attackBehaviour"
                           value="fight" <?php if ($session->heroD['hide'] == 0) {
                        echo 'checked="checked"';
                    } ?>> <label for="attackBehaviourFight"><?= HEROI39 ?></label>
                </div>
            ...
            <table id="attributesOfHero" cellspacing="0" cellpadding="0" class="transparent attributes">
                ...
                <tr id="attributepower" class="attribute power"
                    ...
                    <td class="element progress tooltip">
                        ...
                        <?php if ($freepoints <= 0) { ?>
                    <td class="element points"><?php echo $session->heroD['power'];
                        } ?></td>
                    </td>
                    ...
                    <?php if ($session->heroD['power'] < 100 and $freepoints > 0) {
                        ...
                        <td class="element points">
                            <input type="text" class="text" value="<?php echo $session->heroD['power']; ?>"
                                   name="attributepower">
                        </td>
                ...
                <tr id="attributeoffBonus" class="attribute offBonus" title="<?= HEROI14 ?>||<?= HEROI13 ?>">
                    ...
                    <td class="element progress tooltip">
                        ...
                        <?php if ($freepoints <= 0) { ?>
                    <td class="element points"><?php echo $session->heroD['offBonus'];
                        } ?></td>
                    </td>
                    <?php if ($session->heroD['offBonus'] < 100 and $freepoints > 0) {
                        ...
                        <td class="element points">
                            <input type="text" class="text" value="<?php echo $session->heroD['offBonus']; ?>"
                ...
                <tr id="attributedefBonus" class="attribute defBonus" title="<?= HEROI16 ?>||<?= HEROI15 ?>">
                    ...
                    <td class="element progress tooltip">
                        ...
                        <?php if ($freepoints <= 0) { ?>
                    <td class="element points"><?php echo $session->heroD['defBonus'];
                        } ?></td>
                    </td>
                    <?php if ($session->heroD['defBonus'] < 100 and $freepoints > 0) {
                        ...
                        <td class="element points">
                            <input type="text" class="text" value="<?php echo $session->heroD['defBonus']; ?>"
                ...
                <tr id="attributeproductionPoints" class="attribute productionPoints"
                    ...
                    <td class="element progress tooltip">
                        ...
                        <?php if ($freepoints <= 0) { ?>
                    <td class="element points"><?php echo $session->heroD['product'];
                        } ?></td>
                    </td>
                    <?php if ($session->heroD['product'] < 100 and $freepoints > 0) {
                        ...
                        <td class="element points">
                            <input type="text" class="text" value="<?php echo $session->heroD['product']; ?>"
            ...
            <div class="saveHeroAttributes">
                <button type="button" value="save changes" name="saveHeroAttributes" id="saveHeroAttributes"
                        class="green disabled" disabled="">
                    <div class="button-container addHoverClick">
                        <div class="button-background">
                            <div class="buttonStart">
                                <div class="buttonEnd">
                                    ...
                                    new Travian.Game.Hero.PropertySetter.Attribute.Power(
                                        {
                                            ...
                                            valueBonus: 0
                                        })<?php  } if($session->heroD['offBonus'] < 100){ ?>
                                    ,
