...
if (count($_GET) && isset($_GET['lang'])) {
    if ($_GET['lang'] != 'ru') {
        ...
        $linken = '?' . $_SERVER['QUERY_STRING'];
    }
    if ($_GET['lang'] != 'ru') {
        $linkru = '?' . $_SERVER['QUERY_STRING'] . '&lang=ru';
    } else {
        $linkru = '?' . $_SERVER['QUERY_STRING'];
    }
} elseif (!count($_GET)) {
    $linkru = '?lang=ru';
    $linken = '?lang=ru';
...
<div id="sidebarBeforeContent" class="sidebar beforeContent">
    <div class="sidebarBoxWrapper">
        <div id="sidebarBoxMenu" class="sidebarBox   ">
            ...
            <div class="content">
                <ul>
                    <li class="first"><a href="<?= HOMEPAGE; ?>" target="_blank"><?= HOME ?></a></li>
                    ...
                    <li <?php if (in_array(basename($_SERVER['PHP_SELF']), array('anmelden.php', 'activate.php'))) {
                        echo ' class="active"';
                    } ?> >
                    ...
                    <li <?php if (basename($_SERVER['PHP_SELF']) == "support.php") {
                        echo ' class="active"';
                    } ?> >
