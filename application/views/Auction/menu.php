<div class="contentNavi tabNavi">
    <div class="container <?php if (isset($_GET['action']) && $_GET['action'] == 'buy') {
        echo "active";
    } else {
        echo "normal";
    } ?>">
    ...
    <div class="container <?php if (isset($_GET['action']) && $_GET['action'] == sell) {
        echo "active";
    } else {
        echo "normal";
    } ?>">
    ...
    <div class="container <?php if (isset($_GET['action']) && $_GET['action'] == bids) {
        echo "active";
    } else {
        echo "normal";
    } ?>">
