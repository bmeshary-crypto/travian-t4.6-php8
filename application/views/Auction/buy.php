...
<div id="auction">
        ...
        <div class="boxes boxesColor gray">
            ...
            <div class="boxes-contents">
                <div class="wrapper">
                    ...
                    <div class="silver"><img title="silver" class="silver"
                    ...
                    <div class="filterContainer">
                        ...
                        } ?> onclick="window.location.href = '?action=buy&amp;filter=1'; return false;"><img
                        ...
                        <button title="<?= HEROAC1 ?>" type="button"
                            ...
                            echo "class=\"iconFilter\"";
                        } ?> onclick="window.location.href = '?action=buy&amp;filter=2'; return false;"><img
                        ...
                        <button title="<?= HEROAC2 ?>" type="button"
                            ...
                            echo "class=\"iconFilter\"";
                        } ?> onclick="window.location.href = '?action=buy&amp;filter=3'; return false;"><img
                        ...
                        <button title="<?= HEROAC3 ?>" type="button"
                            ...
                            echo "class=\"iconFilter\"";
                        } ?> onclick="window.location.href = '?action=buy&amp;filter=4'; return false;"><img
                        ...
                        <button title="<?= HEROAC4 ?>" type="button"
                            ...
                            echo "class=\"iconFilter\"";
                        } ?> onclick="window.location.href = '?action=buy&amp;filter=5'; return false;"><img
                        ...
                        <button title="<?= HEROAC5 ?>" type="button"
                            ...
                            echo "class=\"iconFilter\"";
                        } ?> onclick="window.location.href = '?action=buy&amp;filter=6'; return false;"><img
                        ...
                        <button title="<?= HEROAC8 ?>" type="button"
                            ...
                            echo "class=\"iconFilter\"";
                        } ?> onclick="window.location.href = '?action=buy&amp;filter=9'; return false;"><img
    ...
    if ($page != "1") {
        $paginationDisplay .= '<a class="first" href="?action=buy&page=1"><img src="img/x.gif"></a> ';
    } else {
        $paginationDisplay .= '<img src="img/x.gif" class="first disabled"> ';
    }
    if ($page != "1" && $page != $lastPage) {
        $paginationDisplay .= '<a class="previous" href="?action=buy&page=' . $previous . '"><img src="img/x.gif"></a>';
    } else {
