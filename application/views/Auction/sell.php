<div id="auction">
    ...
    if ($page != "1") {
        $paginationDisplay .= '<a class="first" href="?action=sell&page=1"><img src="img/x.gif"></a> ';
    } else {
        $paginationDisplay .= '<img src="img/x.gif" class="first disabled"> ';
    }
    if ($page != "1" && $page != $lastPage) {
        $paginationDisplay .= '<a class="previous" href="?action=sell&page=' . $previous . '"><img src="img/x.gif"></a>';
    } else {
