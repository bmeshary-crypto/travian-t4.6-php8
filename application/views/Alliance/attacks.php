...
?>
    ...
    <div class="boxes boxesColor gray reportFilter offDef">
        ...
        <div class="boxes-contents cf">
            <button onclick="window.location.href = 'allianz.php?s=3&amp;f=31&amp;fn=0'; return false;"
                    class="iconFilter <?php echo(($_GET['f'] == 31) ? 'iconFilterActive' : ''); ?> " type="button"><img
                        alt="att_all" class="att_all" src="img/x.gif"></button>
            <button onclick="window.location.href = 'allianz.php?s=3&amp;f=32&amp;fn=0'; return false;"
                    class="iconFilter <?php echo(($_GET['f'] == 32) ? 'iconFilterActive' : ''); ?>" type="button"><img
                        alt="def_all" class="def_all" src="img/x.gif"></button>
        </div>
    </div>
<?php
if ($_GET['f'] == 31) {
