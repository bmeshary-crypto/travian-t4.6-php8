...
<form method="POST" action="allianz.php?ss=5">
    <input type="hidden" name="a" value="6"> <input type="hidden" name="o" value="6"> <input type="hidden" name="s"
                                                                                             value="5">
    ...
    <div class="option diplomacy">
        <table cellpadding="1" cellspacing="1" class="option transparent">
            ...
            <tr>
                <td colspan="2"><label><input class="radio" type="radio" name="dipl" value="1"><?php echo ALLIANCE14; ?>
                    </label></td>
            </tr>

            <tr>
                <td colspan="2"><label><input class="radio" type="radio" name="dipl" value="2"><?php echo ALLIANCE15; ?>
                    </label></td>
            </tr>

            <tr>
                <td colspan="2"><label><input class="radio" type="radio" name="dipl" value="3"><?php echo ALLIANCE16; ?>
                    </label></td>
            </tr>
            </tbody>
        </table>
