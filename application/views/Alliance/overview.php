    ...
    <script type="text/javascript">
        jQuery('#buttonO7').click(function(event) {
            jQuery(window).trigger('tabClicked', [this, {
                ...
                "target": false,
                "id": "buttonO7",
                "href": "allianz.php?<?php echo ($_GET['aid'] ? 'aid=' . $_GET['aid'] . '&' : ''); ?>action=description",
                "onclick": false,
                "enabled": true,
                "text": "Description",
                "dialog": false,
        ...
        if (jQuery('#buttonI8')) {
            jQuery('#buttonI8').click(function(event) {
                jQuery(window).trigger('tabClicked', [this, {
                    ...
                    "target": false,
                    "id": "buttonI8",
                    "href": "allianz.php?<?php echo ($_GET['aid'] ? 'aid=' . $_GET['aid'] . '&' : ''); ?>action=members",
                    "onclick": false,
                    "enabled": true,
                    "text": "Members",
                    "dialog": false,
