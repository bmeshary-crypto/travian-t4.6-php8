...
<form action="spieler.php" method="POST">
    ...
    <table cellpadding="1" cellspacing="1" id="editDetails" class="transparent">
        ...
        <tr>
            ...
            <td class="birth">
                ...
                <input tabindex="3" type="text" name="jahr" value="<?php echo $bday[0]; ?>" maxlength="4"
                       class="text year">
                <select tabindex="2" name="monat" class="dropdown">
                    <option value="0"></option>
                    <option value="1" <?php if ($bday[1] == 1) {
                        echo "selected";
                    } ?>>Jan
                    </option>
                    <option value="2" <?php if ($bday[1] == 2) {
                        echo "selected";
                    } ?>>Feb
                    </option>
                    <option value="3" <?php if ($bday[1] == 3) {
                        echo "selected";
                    } ?>>Mar
                    </option>
                    <option value="4" <?php if ($bday[1] == 4) {
                        echo "selected";
                    } ?>>Apr
                    </option>
                    <option value="5" <?php if ($bday[1] == 5) {
                        echo "selected";
                    } ?>>May
                    </option>
                    <option value="6" <?php if ($bday[1] == 6) {
                        echo "selected";
                    } ?>>Jun
                    </option>
                    <option value="7" <?php if ($bday[1] == 7) {
                        echo "selected";
                    } ?>>Jul
                    </option>
                    <option value="8" <?php if ($bday[1] == 8) {
                        echo "selected";
                    } ?>>Aug
                    </option>
                    <option value="9" <?php if ($bday[1] == 9) {
                        echo "selected";
                    } ?>>Sep
                    </option>
                    <option value="10" <?php if ($bday[1] == 10) {
                        echo "selected";
                    } ?>>Oct
                    </option>
                    <option value="11" <?php if ($bday[1] == 11) {
                        echo "selected";
                    } ?>>Nov
                    </option>
                    <option value="12" <?php if ($bday[1] == 12) {
                        echo "selected";
                    } ?>>Dec
                    </option>
                </select>
                <input tabindex="1" class="text day" type="text" name="tag" value="<?php echo $bday[2]; ?>"
                       maxlength="2">
            </td>
            <th class="gender" rowspan="2"><?php echo $lang['Profile']['03']; ?></th>
            <td class="gender" rowspan="2">
                <label>
                    <input class="radio" type="radio" name="mw" value="0" <?php if ($userv['gender'] == 0) {
                        echo "checked";
                    } ?> tabindex="5"> <?php echo $lang['Profile']['04']; ?></label><br>
                <label>
                    <input class="radio" type="radio" name="mw" <?php if ($userv['gender'] == 1) {
                        echo "checked";
                    } ?> value="1"> <?php echo $lang['Profile']['05']; ?></label><br>
                <label>
                    <input class="radio" type="radio" name="mw" <?php if ($userv['gender'] == 2) {
                        echo "checked";
                    } ?> value="2"> <?php echo $lang['Profile']['06']; ?></label>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input tabindex="5" type="text" name="ort" value="<?php echo $userv['location']; ?>" maxlength="30"
                       class="text"></td>
        </tr>
    ...
    <textarea tabindex="7" style="text-align:center;" class="editDescription editDescription1"
              name="be2"><?php echo $userv['desc2']; ?></textarea>
    <textarea tabindex="6" style="text-align:center;" class="editDescription editDescription2"
              name="be1"><?php echo $userv['desc1']; ?></textarea>
    <div class="clear"></div>
