...
if ($session->sit == 0) {
    ...
    <form action="options.php?s=2" method="POST">
        ...
        <table class="sitters transparent">
            ...
            <tr>
                <th>
                    <div class="lightGreen"><span><?= ACC21 ?> 1</span></div>
                    </div>
                </th>
                <td>
                    <?php
            ...
            <tr>
                <th>
                    <div class="orange"><span><?= ACC21 ?> 2</span></div>
                    </div>
                </th>
                <td>
                    <?php
        ...
        <table cellspacing="1" cellpadding="1" class="sitters2 spacer">
            ...
            <tr>
                <th><?= accsit0 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights['s1'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s1" value="<?= $rights['s1'] ?>"></td>
                <td><input type="checkbox" class="check" <?= ($rights['s21'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s21" value="<?= $rights['s21'] ?>"></td>
            </tr>
            <tr>
                <th><?= accsit1 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights['s2'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s2" value="<?= $rights['s2'] ?>"></td>
                <td><input type="checkbox" class="check" <?= ($rights['s22'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s22" value="<?= $rights['s22'] ?>"></td>
            </tr>
            <tr>
                <th><?= accsit2 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights['s3'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s3" value="<?= $rights['s3'] ?>"></td>
                <td><input type="checkbox" class="check" <?= ($rights['s23'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s23" value="<?= $rights['s23'] ?>"></td>
            </tr>
            <tr>
                <th><?= accsit3 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights['s4'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s4" value="<?= $rights['s4'] ?>"></td>
                <td><input type="checkbox" class="check" <?= ($rights['s24'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s24" value="<?= $rights['s24'] ?>"></td>
            </tr>
            <tr>
                <th><?= accsit4 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights['s5'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s5" value="<?= $rights['s5'] ?>"></td>
                <td><input type="checkbox" class="check" <?= ($rights['s25'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s25" value="<?= $rights['s25'] ?>"></td>
            </tr>
            <tr>
                <th><?= accsit5 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights['s6'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s6" value="<?= $rights['s6'] ?>"></td>
                <td><input type="checkbox" class="check" <?= ($rights['s26'] == 1) ? 'checked="checked"' : ''; ?>
                           name="s26" value="<?= $rights['s26'] ?>"></td>
            </tr>
            </tbody>
        </table>
        ...
        <table cellspacing="1" cellpadding="1" class="sitters2 spacer">
            ...
            <tr>
                <th><?= accsit0 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights1['s1'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
                <td><input type="checkbox" class="check" <?= ($rights2['s21'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
            </tr>
            <tr>
                <th><?= accsit1 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights1['s2'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
                <td><input type="checkbox" class="check" <?= ($rights2['s22'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
            </tr>
            <tr>
                <th><?= accsit2 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights1['s3'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
                <td><input type="checkbox" class="check" <?= ($rights2['s23'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
            </tr>
            <tr>
                <th><?= accsit3 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights1['s4'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
                <td><input type="checkbox" class="check" <?= ($rights2['s24'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
            </tr>
            <tr>
                <th><?= accsit4 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights1['s5'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
                <td><input type="checkbox" class="check" <?= ($rights2['s25'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
            </tr>
            <tr>
                <th><?= accsit5 ?></th>
                <td><input type="checkbox" class="check" <?= ($rights1['s6'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
                <td><input type="checkbox" class="check" <?= ($rights2['s26'] == 1) ? 'checked="checked"' : ''; ?>
                           disabled="disabled"></td>
            </tr>
            </tbody>
        </table>
...
//if($timestamp > time()+12*3600) {
                    ...
                    <button type="button" class="icon"
                            onclick="window.location.href = 'options.php?s=3&delcancel=1'; return false;">
                    ...
                    echo ACC19; ?> <span class="timer" counting="down"
                                         value="<?php echo($timestamp - time()); ?>"><?php echo $time; ?></span></td><?php
                }
                else {
                ?>
        ...
        <div class="save_button">
            <button type="submit" class="textButtonV1 green">
