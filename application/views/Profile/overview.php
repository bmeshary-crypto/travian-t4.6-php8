...
<table cellpadding="1" cellspacing="1" id="details" class="transparent">
    ...
    <th><b style="color:#094D9C;"><?php if ($session->lang == 'ar') {
                                        echo 'Tanrı';
                                    } else {
                                        echo 'Divinity';
                                    } ?></b>⚡</th>

    <td><?php if ($displayarray['god'] == 1) {
            echo '<img src="https://gpack.newtravian.com/gpack/0/travian_default/img/gods/Hera.png" height="15"> Hera';
        } elseif ($displayarray['god'] == 2) {
            echo '<img src="https://gpack.newtravian.com/gpack/0/travian_default/img/gods/Ares.png" height="15"> Ares';
        } elseif ($displayarray['god'] == 3) {
            echo '<img src="https://gpack.newtravian.com/gpack/0/travian_default/img/gods/Athena.png" height="15"> Athena';
        } elseif ($displayarray['god'] == 4) {
            echo '<img src="https://gpack.newtravian.com/gpack/0/travian_default/img/gods/Artemis.png" height="15"> Artemis';
        } elseif ($displayarray['god'] == 0) {
            echo '✘';
        } ?></td>
    </tr>
    ...
    <td><?php if ($displayarray['goldclub'] == 1) {
            echo '✔';
        } else {
            echo '✘';
        } ?></td>
    ...
    <tr>
        ...
        <td><?php
            echo 'Rank ' . $displayarray['rutbe_seviye'] . '';
            ?></td>
    </tr>
    ...
    ?><tr>
            ...
            <td> <?php echo "<img src='img/flags/" . $displayarray['location'] . ".png'>"; ?></td>
        </tr>
    <?php }
    ?>

    <tr>
        <th><?php if ($session->lang == 'ar') {
                echo 'Koruma';
            } else {
                echo 'Protection';
            } ?></th>
        <td><?php
            if ($displayarray['protect'] > 0) {
                echo '<b>✔<br>';
                echo date('d.m H:i', $displayarray['ptime']);
                echo '</b>';
            } else {
                echo '✘';
            }
    ...
    <tr>
        ...
        <td><?php echo $database->getHeroData($displayarray['id'])['level']; ?> <span class="greyInfo">(<?php echo $database->getHeroData($displayarray['id'])['experience']; ?> <?php echo $lang['profile'][8]; ?>)</span>
        </td>
    </tr>
    ...
    <tr>
        ...
        ?>
                <td colspan="2" id="player_message-ignore-buttons-block"><span class="notice"><?php echo Ignored03; ?></span><br><a href="" id="ignore-player-button" data-player-ignored="true" data-uid="<?php echo $uid; ?>">Stop
                        ignoring this player.</a></td>
        <?php
            }
        }
        ?>
