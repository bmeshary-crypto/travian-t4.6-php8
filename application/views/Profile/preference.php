...
<div class="boxes boxesColor gray recommendedLinks">
    ...
    <div class="boxes-contents cf">
        ...
        <div id="linkRecommendations" class="">
            These are links that I found in a From before the number of From Players. Add them to List the Your Own
            Person Links.
            <table class="transparent" cellpadding="1" cellspacing="1" id="recommendedLinks">
                ...
                <tr id="recommendedLinksRow0">
                    ...
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="questions" maxlength="30"
                               disabled="disabled">
                    </td>
                    <td class="link">
                        <input class="text" type="text" name="linkziel" value="http://t4.answers.travian.com/?lang=ae"
                ...
                <tr id="recommendedLinksRow1">
                    <td class="nr">
                        <input class="text" type="text" name="nr" value="0" size="1" maxlength="3" disabled="disabled">
                    </td>
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="Overview on village" maxlength="30"
                               disabled="disabled">
                    </td>
                    <td class="link">
                        <input class="text" type="text" name="linkziel" value="dorf3.php?s=0" maxlength="255"
                               disabled="disabled">
                    </td>
                    <td class="add">
                ...
                <tr id="recommendedLinksRow2">
                    <td class="nr">
                        <input class="text" type="text" name="nr" value="0" size="1" maxlength="3" disabled="disabled">
                    </td>
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="Overview on Warehouses" maxlength="30"
                               disabled="disabled">
                    </td>
                    <td class="link">
                        <input class="text" type="text" name="linkziel" value="dorf3.php?s=3" maxlength="255"
                               disabled="disabled">
                    </td>
                    <td class="add">
                ...
                <tr id="recommendedLinksRow3">
                    <td class="nr">
                        <input class="text" type="text" name="nr" value="0" size="1" maxlength="3" disabled="disabled">
                    </td>
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="Reports alliance" maxlength="30"
                               disabled="disabled">
                    </td>
                    <td class="link">
                        <input class="text" type="text" name="linkziel" value="allianz.php?s=3" maxlength="255"
                               disabled="disabled">
                    </td>
                    <td class="add">
                ...
                <tr id="recommendedLinksRow4">
                    <td class="nr">
                        <input class="text" type="text" name="nr" value="0" size="1" maxlength="3" disabled="disabled">
                    </td>
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="Nearby villages" maxlength="30"
                               disabled="disabled">
                    </td>
                    <td class="link">
                        <input class="text" type="text" name="linkziel" value="reports.php?t=5" maxlength="255"
                               disabled="disabled">
                    </td>
                    <td class="add">
                ...
                <tr id="recommendedLinksRow5">
                    <td class="nr">
                        <input class="text" type="text" name="nr" value="0" size="1" maxlength="3" disabled="disabled">
                    </td>
                    <td class="nam">
                        <input class="text" type="text" name="linkname" value="the memories" maxlength="30"
                               disabled="disabled">
                    </td>
                    <td class="link">
                        <input class="text" type="text" name="linkziel" value="options.php" maxlength="255"
                               disabled="disabled">
                    </td>
                    <td class="add">
...
<form action="spieler.php?s=2" id="settings" method="POST">
    ...
    <table class="transparent" cellpadding="1" cellspacing="1" id="links">
        ...
        foreach ($links as $link): ?>
            <tr>
                <td>
                    <a href="spieler.php?del=<?php echo $link['id']; ?>&s=2"><img class="del" src="img/x.gif"
                                                                                  alt="delete" title="delete"></a>
                </td>
                <td class="nr"><input <?php if (!$session->plus) {
                        echo "disabled";
                    } ?> class="text" type="text" name="nr<?php print $i; ?>"
                         value="<?php print $database->RemoveXSS($link['pos']); ?>" size="1" maxlength="3"/><input
                            type="hidden" name="id<?php print $i; ?>" value="<?php print $link['id']; ?>"/></td>
                <td class="nam"><input <?php if (!$session->plus) {
                        echo "disabled";
                    } ?> class="text" type="text" name="linkname<?php print $i; ?>"
                         value="<?php print $database->RemoveXSS($link['name']); ?>" maxlength="30"/></td>
                <td class="link"><input <?php if (!$session->plus) {
                        echo "disabled";
                    } ?> class="text" type="text" name="linkziel<?php print $i; ?>"
                         value="<?php print $database->RemoveXSS($link['url']); ?>" maxlength="255"/></td>
            </tr>
            <?php ++$i;
            $last_pos = $link['pos']; endforeach; ?>
        <tr>
            <td></td>
            <td class="nr"><input <?php if (!$session->plus) {
                    echo "disabled";
                } ?> class="text" type="text" name="nr<?php print $i; ?>" value="<?php print ($last_pos + 1); ?>"
                     size="1" maxlength="3"></td>
            <td class="nam"><input <?php if (!$session->plus) {
                    echo "disabled";
                } ?> class="text" type="text" name="linkname<?php print $i; ?>" value="" maxlength="30"></td>
            <td class="link"><input <?php if (!$session->plus) {
                    echo "disabled";
                } ?> class="text" type="text" name="linkziel<?php print $i; ?>" value="" maxlength="255"></td>
        </tr>
