...
var timeout;
var i = 0;
var str = 'Bu bölümde hesabınıza uygun özellikleri satın alabilirsiniz! ';
function add() {
...
timeout = setInterval('add()', 50);
		...
		<h1 align="center">Hello <?php echo $session->username; ?></h1><br/>
		<div id="texty"></div>
		<noscript><marquee behavior="scroll" direction="left" scrollamount="2">Hello, In this section, you can buy features suitable for your account! </marquee></noscript></center>
...
?><div class="questAchievementContainer" >
    ...
    <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" alt="Gold" title="Gold"/>20</td>
    <td class="act">
...
<tr>
    ...
    <td class="desc">
        +<b>25</b>% <img class="r1" src="img/x.gif" alt="Дерево" title="Дерево"/> <?=pluss34?><br/>
				<span class="run">
<?php
