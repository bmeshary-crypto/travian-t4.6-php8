...
Travian.Game = {currentPage: window.location.href.split("/").pop().split(".php", 2).shift(), eventJamHtml: null, speed: 1, version: 4, worldId: null, ajaxUpdate: function (b, a) {
        ...
        Travian.ajax({
            ...
            onSuccess:function(e){
                if(id<13 && id>7){
                    ...
                    if(hours==''){
                        $("hour"+id).innerHTML=" часов <b>0</b> минут";
    ...
    , iPopup: function (a, b) {
    ('<iframe class="popup" frameborder="0" id="Frame" src="manual.php?typ=' + b + "&amp;gid=" + a + '" width="475" height="500" scrolling="no" border="0" allowTransparency="true"></iframe>').dialog({title: "{allgemein.anleitung}".translate(), buttonOk: false, enableBackground: false, draggable: true, fx: {options: {duration: 0}}});
    return false
}, unitZoom: function (a) {
