...
<tr>
    ...
    <td class="desc">Tüm Kaynaklardan  <?= HOWRES ?>*4 Miktar Al</td>
    <td class="dur"><?=PLUS20?></td>
...
if($session->gold >= COSTRES) {
    echo "<center><button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".HOWRES."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
...
<tr>
    ...
    <td class="desc">Tüm Kaynaklardan  <?= HOWRES2 ?>*4 Miktar Al</td>
    <td class="dur"><?=PLUS20?></td>
    <td class="cost"><img src="img/x.gif" class="gold" alt="Altın" title="Altın" /><span id='costres'><?=COSTRES2?></span></td>
    <td class="act"><span class="none">
<?php



if($session->gold >= COSTRES2) {
    echo "<center><button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".HOWRES2."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
...
if($session->gold >= COSTASKER) {
    echo "<center><button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".asker."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
...
if($session->gold >= COSTASKER1) {
    echo "<center><button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".asker1."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
...
if($session->gold >= COST20YAP) {
    echo "<center><button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".atal."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
...
<table class="plusFunctions" cellpadding="1" cellspacing="1">
    ...
    <tr>
        <td class="desc">
			...
			- Her Yeni Server Otomatik Gold Üyelik
	</br>- Her Yeni Server Otomatik Vip Üyelik
	</br>- Her Yeni Server Daha Hızlı Gelişme
</br>- Her Yeni Server Renkli İsim
</br>- Her Yeni Server VIP Titlesi(Başlığı)<br>
                <?=PLUS33?><br/>
                <?=PLUS34?><br/>
                <?=PLUS35?><br/>
                <?=PLUS36?><br/>
        ...
        <td class="act">
           ...
           if ($session->gold >= COSTVIP) {
                   echo "<center><button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".vipal."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
