...
<?php
if ($session->gold > 2) {
    echo "<button class=\"green ".$disabl."\" type=\"button\"  onclick=\"window.location.href = 'build.php?gid=17&t=3'; return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS21."</div></div></button>";
...
<tr>
    ...
    <td class="dur"><?=PLUS20?></td>
    <td class="cost"><img src="img/x.gif" class="gold" alt="Altın" title="Altın" /><span id='costres'><?=COSTRES?></span></td>
    <td class="act"><span class="none">
<?php
...
<tr>
    ...
    <td class="desc">Bütün Askerlerden <?="".asker."" ?> Adet</td>
    <td class="dur">Şimdi</td>
    <td class="cost"><img src="img/x.gif" class="gold" alt="Altın" title="Altın" /><span id='costasker'><?= COSTASKER ?></span></td>
    <td class="act"><span class="none">
<?php



if($session->gold >= COSTASKER) {
    echo "<button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".asker."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
    echo "<button type=\"button\" class=\"gold \"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container\"><div class=\"button-position\"><div class=\"btl\"><div class=\"btr\"><div class=\"btc\"></div></div></div><div class=\"bml\"><div class=\"bmr\"><div class=\"bmc\"></div></div></div><div class=\"bbl\"><div class=\"bbr\"><div class=\"bbc\"></div></div></div></div><div class=\"button-contents\">".PLUS14."</div></div></button>";
    echo "<button class=\"gold \" type=\"button\"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".pluss27."</div></div></button>";
...
<tr>
    ...
    <td class="desc">Bütün Askerlerden <?="".asker1."" ?> Adet</td>
    <td class="dur">Şimdi</td>
    <td class="cost"><img src="img/x.gif" class="gold" alt="Altın" title="Altın" /><span id='costasker'><?= COSTASKER1 ?></span></td>
    <td class="act"><span class="none">
<?php



if($session->gold >= COSTASKER1) {
    echo "<button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".asker1."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
    echo "<button type=\"button\" class=\"gold \"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container\"><div class=\"button-position\"><div class=\"btl\"><div class=\"btr\"><div class=\"btc\"></div></div></div><div class=\"bml\"><div class=\"bmr\"><div class=\"bmc\"></div></div></div><div class=\"bbl\"><div class=\"bbr\"><div class=\"bbc\"></div></div></div></div><div class=\"button-contents\">".PLUS14."</div></div></button>";
    echo "<button class=\"gold \" type=\"button\"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".pluss27."</div></div></button>";
...
<tr>
    ...
    <td class="desc">Bütün Hammaddeleri <?="".maxlvlyap."" ?> Yap</td>
    <td class="dur">Şimdi</td>
    <td class="cost"><img src="img/x.gif" class="gold" alt="Altın" title="Altın" /><span id='costasker'><?= COST20YAP ?></span></td>
    <td class="act"><span class="none">
<?php



if($session->gold >= COST20YAP) {
    echo "<button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".maxlvlyap."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
    echo "<button type=\"button\" class=\"gold \"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container\"><div class=\"button-position\"><div class=\"btl\"><div class=\"btr\"><div class=\"btc\"></div></div></div><div class=\"bml\"><div class=\"bmr\"><div class=\"bmc\"></div></div></div><div class=\"bbl\"><div class=\"bbr\"><div class=\"bbc\"></div></div></div></div><div class=\"button-contents\">".PLUS14."</div></div></button>";
    echo "<button class=\"gold \" type=\"button\"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".pluss27."</div></div></button>";
...
<tr>
    ...
    <td class="desc">Kahramınına <?="".atal."" ?> Şanlı Şöhretli Atını Al</td>
    <td class="dur">Şimdi</td>
    <td class="cost"><img src="img/x.gif" class="gold" alt="Altın" title="Altın" /><span id='costbuyat'><?= COSTBUYAT ?></span></td>
    <td class="act"><span class="none">
<?php
...
if($session->gold >= COST20YAP) {
    echo "<button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".atal."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
    echo "<button type=\"button\" class=\"gold \"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container\"><div class=\"button-position\"><div class=\"btl\"><div class=\"btr\"><div class=\"btc\"></div></div></div><div class=\"bml\"><div class=\"bmr\"><div class=\"bmc\"></div></div></div><div class=\"bbl\"><div class=\"bbr\"><div class=\"bbc\"></div></div></div></div><div class=\"button-contents\">".PLUS14."</div></div></button>";
    echo "<button class=\"gold \" type=\"button\"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".pluss27."</div></div></button>";
...
<tr>
    ...
    <td class="desc">Bir saat asker eğitin</td>
    <td class="dur">Şimdi</td>
    <td class="cost"><img src="img/x.gif" class="gold" alt="Altın" title="Altın" /><span id='costres'><?=COSTRES?></span></td>
    <td class="act"><span class="none">
<?php
...
<table class="plusFunctions" cellpadding="1" cellspacing="1">
    ...
    <tr>
        <td class="desc">
            ...
            <center> <b>VIP</b>
            <br/>
            <small><b>VIP Özellikleri</b><br/>
			- Her Yeni Server Gold Üyelik
	</br>- Her Yeni Server 4000 Altın
	</br>- Her Yeni Server Daha Hızlı Gelişme
	</br>- Kalıcı Efsane Madalya <img src="img/yeni4.gif">
	</br>- Kalıcı Özel Madalya <img src="img/yeni4.gif"><br>
                <?=PLUS33?><br/>
                <?=PLUS34?><br/>
                <?=PLUS35?><br/>
                <?=PLUS36?><br/>
        ...
        <td class="cost"><img src="img/x.gif">100 TL</td>
        <td class="act">
            <?php
           if($session->gold >= COSTVIP) {
    echo "<button type=\"button\"  class=\"green ".$disabl."\" onclick=\"return Travian.Game.buyplus(13,".vipal."); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".PLUS26."</div></div></button>";
} else {
    echo "<button type=\"button\" class=\"gold \"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container\"><div class=\"button-position\"><div class=\"btl\"><div class=\"btr\"><div class=\"btc\"></div></div></div><div class=\"bml\"><div class=\"bmr\"><div class=\"bmc\"></div></div></div><div class=\"bbl\"><div class=\"bbr\"><div class=\"bbc\"></div></div></div></div><div class=\"button-contents\">".PLUS14."</div></div></button>";
    echo "<button class=\"gold \" type=\"button\"  class=\" disabled\" onclick=\"(new Event(event)).stop(); return false;\" onfocus=\"$$('button', 'input[type!=hidden]', 'select')[0].focus(); (new Event(event)).stop(); return false;\"><div class=\"button-container addHoverClick \">     <div class=\"button-background\">         <div class=\"buttonStart\">             <div class=\"buttonEnd\">                 <div class=\"buttonMiddle\"></div>             </div>         </div>     </div>     <div class=\"button-content\">".pluss27."</div></div></button>";
