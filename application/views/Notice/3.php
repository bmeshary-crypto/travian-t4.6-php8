<div id="reportWrapper">
    ...
    <div class="body">
        <div class="victory">
            ...
            <img src="img/x.gif"
                 class="tribe tribe<?php echo $database->getUserInfo($dataarray[0])['tribe']; ?> attacker lost" alt="">
            <img src="img/x.gif"
                 class="tribe tribe<?php echo $database->getUserInfo($dataarray[27])['tribe']; ?> defender won" alt="">
        </div>
        <div class="role attacker">
            ...
            <div class="troopHeadline ">
                <div>
                    ...
                    <a class="player"
                       href="spieler.php?uid=<?= $dataarray[0] ?>"><?= $dataarray[1] ?></a> <?= REPORT_FROM_VIL ?> <a
                            class="village"
                            href="karte.php?d=<?= $dataarray[2] . "&amp;c=" . $generator->getMapCheck($dataarray[2]); ?>"><?= $dataarray[3] ?></a>
                </div>
                <div class="toolList">
                    <?php if ($dataarray[0] == $session->uid) { ?>
                        <a class="iconButton" title="return attack"
                           href="build.php?t=2&id=39&z=<?php echo $dataarray[29]; ?>&nid=<?php echo $_GET['id']; ?>&re"><i
                                    style="top:-3px" class="simulate"></i></a>
                    <?php } ?>
                </div>
            </div>
            <table id="attacker" class="attacker" cellpadding="0" cellspacing="0">
                ...
                if ($dataarray[33]) { //cata
                    ...
                    <tr>
                        <th><?= rpts3 ?></th>
                        <td colspan="11">
                            <img class="unit u<?= ($dataarray[4] - 1) * 10 + 8; ?>" src="img/x.gif" alt="Catapult"
                                 title="Catapult"/>
        ...
        <div class="role defender">
            ...
            <div class="troopHeadline ">
                <div>
                    <a class="player"
                       href="spieler.php?uid=<?php echo $dataarray[27]; ?>"><?php echo $dataarray[28]; ?></a> From <a
                            class="village"
                            href="karte.php?d=<?php echo $dataarray[29]; ?>&amp;c=<?php echo $generator->getMapCheck($dataarray[29]); ?>"><?php echo $dataarray[30]; ?></a></p>
                </div>
