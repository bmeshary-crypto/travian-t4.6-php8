...
<div id="reportWrapper">
    ...
    <div class="body">
        <div class="victory">
            ...
            <img src="img/x.gif"
                 class="tribe tribe<?php echo $database->getUserInfo($dataarray[37])['tribe']; ?> defender won" alt="">
        </div>
                ...
                <tr>
                    ...
                    <td colspan="11">
                        ...
                        <div class="carry">
                            ...
                            ?>
                            <?php echo number_format($dataarray[29] + $dataarray[30] + $dataarray[27] + $dataarray[28]); ?></div>
                    </td>
                </tr>
                </tbody>
                </tbody>
