...
<form method="post" action="berichte.php" name="msg">
    ...
    <button name="realAll" type="submit" value="realAll" id="realAll" class="green textButtonV3">
        <div class="button-container addHoverClick ">
            ...
            <div class="button-content">
                <?php echo markASRead; ?></div>
        </div>
    </button>

    <?php if (!$session->sit && $session->right['s6']) { ?>
        <button name="del_x" type="submit" value="del" id="del" class="green delete textButtonV3">
            <div class="button-container addHoverClick ">
                <div class="button-background">
                    <div class="buttonStart">
                        <div class="buttonEnd">
