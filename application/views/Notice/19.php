    ...
    <div class="layout">
        <div class="paperTop">
            <div class="paperContent">
                ...
                <div id="message">
                    <img src="img/x.gif" class="reportImage reportType6" alt="">
                            ...
                            <td class="role">
                                <div class="boxes boxesColor red">
                                    ...
                                    <div class="boxes-contents cf">
                                        <div class="role"><?= rpts11 ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="troopHeadline" colspan="10"><p><a
                                            href="spieler.php?uid=<?php echo $database->getUserField($dataarray[0], "id", 0); ?>"><?php echo $database->getUserField($dataarray[0], "username", 0); ?></a> <?= rpts4 ?>
                        ...
                        <tr>
                            <td class="role">
                                <div class="boxes boxesColor green">
                                    ...
                                    <div class="boxes-bc"></div>
                                    <div class="boxes-contents cf">
                                        <div class="role"><?= rpts9 ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="troopHeadline" colspan="10">
                                <p><?php echo '<a href="spieler.php?uid=' . $database->getUserField($dataarray[24], "id", 0) . '">' . $database->getUserField($dataarray[23], "username", 0) . '</a> ' . rpts4 . '  <a href="karte.php?d=' . $dataarray[24] . '&amp;c=' . $generator->getMapCheck($dataarray[24]) . '">' . $database->getVillageField($dataarray[24], "name") . '</a>'; ?></p>
                            </td>
                        </tr>
                        </thead>
                        <tbody class="units">
