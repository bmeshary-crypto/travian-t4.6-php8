<?php
$FLs=$database->getVilUFl($village->wid,$session->uid); //все фармсписки для этой деры
 
if(isset($_POST['action']) == 'editAllSlot' && $_POST['lid']) {
foreach($FLs as $a){
        $arrayka[]=$a['id'];
    }
    if(!in_array($_POST['lid'],$arrayka)){ die(farmlist13);}
	
if($session->tribe==3 || $session->tribe==7){ $_POST['t3']=0;}else{$_POST['t4']=0;}
$troops = $_POST['t1']+$_POST['t2']+$_POST['t3']+$_POST['t4']+$_POST['t5']+$_POST['t6']+$_POST['t7']+$_POST['t8']+$_POST['t9']+$_POST['t10'];
    ...
    if($troops == 0){
		...
		$database->editAllSlotFarm($_POST['lid'],$_POST['t1'], $_POST['t2'], $_POST['t3'], $_POST['t4'], $_POST['t5'], $_POST['t6'], $_POST['t7'], $_POST['t8'], $_POST['t9'], $_POST['t10']);
...
<?php echo $errormsg; ?>
	...
	<form id="edit_form" action="build.php?id=39&t=99&action=showAllSlot&lid=<?php echo $_GET['lid']; ?>" method="post">
		<div class="boxes boxesColor gray"><div class="boxes-tl"></div><div class="boxes-tr"></div><div class="boxes-tc"></div><div class="boxes-ml"></div><div class="boxes-mr"></div><div class="boxes-mc"></div><div class="boxes-bl"></div><div class="boxes-br"></div><div class="boxes-bc"></div><div class="boxes-contents cf">

		<input type="hidden" name="action" value="editAllSlot">
...
$lvname = $village->vname;
	...
	if($lid==$_GET['lid']){ $selected = 'selected=""'; }else{ $selected = ''; }
...
?>	
            ...
            for($i=1;$i<=10;$i++){
                $spy='';
                if($i==3 && $session->tribe==3 || $i==4 && $session->tribe==1 || $i==4 && $session->tribe==2 || $i==4 && $session->tribe==6 || $i==3 && $session->tribe==7){
