...
if (isset($_GET['t']) == 99 && isset($_GET['action']) == 0) {
    ...
    foreach ($sql as $row0) {
        ...
        if ($lwref == $village->wid) {
            ...
            <div id="list<?php echo $lid; ?>" class="listEntry">
                <form action="build.php?id=39&t=99&action=startRaid" method="post">
                    ...
                    <div class="round spacer listTitle">
                        <div class="listTitleText">
                            <img alt="del" class="del" src="img/x.gif"
                                 onclick="window.location = 'build.php?id=39&amp;t=99&amp;action=deleteList&amp;lid=<?php echo $lid; ?>';">
                            <?php echo $lvname; ?> - <?php echo $lname; ?>

                            <div style="float:left;" class="openedClosedSwitch switchOpened"
                                        ...
                                        <tr class="slotRow">
                                            <td class="checkbox">
                                                <?php if ($checked[$lid] == 0) { ?>
                                                    <input id="slot<?php echo $id; ?>" name="slot<?php echo $id; ?>"
                                                           type="checkbox" class="markSlot"
                                                           onclick="Travian.Game.RaidList.markSlotForRaid(<?php echo $lid; ?>, <?php echo $id; ?>, this.checked);">
                                                <?php } else { ?>
                                                    <input id="slot<?php echo $id; ?>" name="slot<?php echo $id; ?>"
                                                           type="checkbox" class="markSlot" checked>
                                                <?php } ?>
                                            </td>
                                            <td class="village">
                                                <?php
                ...
                <span class="coordText"><?php echo $vdata['name']; ?></span>
                                            ...
                                            <td class="action">
                                                ...
                                                <a class="arrow" href="#"
                                                   onclick="window.location.href = 'build.php?gid=16&t=99&action=showSlot&eid=<?php echo $id; ?>&sort=distance&direction=asc'; return false;">Modification</a>
                                            </td>
                                        </tr>
                            ...
                            <div class="markAll">
                                ...
                                <?php } else { ?>
                                    <input type="checkbox" id="raidListMarkAll<?php echo $lid; ?>" class="markAll"
                                           onclick="window.location.href = '?id=39&t=99';" checked>
                                <?php } ?>
                            ...
                            <div class="addSlot">
                                <button type="button"
                                        onclick="window.location.href = 'build.php?id=39&t=99&action=showSlot&lid=<?php echo $lid; ?>'; return false;"
            ...
            <span class="troopSelectionValue">0</span>
                        ...
                        <button type="submit"
                                class="green textButtonV1 <?= (($lstart < time() - farmList) ? '' : 'disabled') ?>" <?= (($lstart < time() - farmList) ? '' : 'onclick="return false;"') ?>>
                            <div class="button-container addHoverClick ">
                                <div class="button-background">
                                    <div class="buttonStart">
                                        <div class="buttonEnd">
                                ...
                                <div class="button-content"><?= farmlist7 ?>
                                    <?php if (!($lstart > time() - farmList)) $database->query("UPDATE users SET gold = gold- 10  WHERE id =" . $session->uid . "") ?>
                                    <?php if ($lstart > time() - farmList) { ?><span
                                        id='timer<?= $timer ?>'><?= $generator->getTimeFormat($lstart + farmList - time()) ?></span>
                                    <?php } ?>
                                </div>
                            </div>
                        </button>
    ...
    <div id="raidList">
        <div class="options"><a class="arrow" href="#" onclick="Travian.Game.RaidList.showCreateNewList()">Create a new
                list</a></div>
    </div>
    <?php
}
    ...
    <script type="text/javascript">
        window.addEvent('domready', function () {
            Travian.Game.RaidList.setData({
                ...
                "<?php echo $lid; ?>": {
                    "troops": {
                        "1":<?php echo $village->unitarray['u1']; ?>,
                        "2":<?php echo $village->unitarray['u2']; ?>,
                        "3":<?php echo $village->unitarray['u3']; ?>,
                        "4":<?php echo $village->unitarray['u4']; ?>,
                        "5":<?php echo $village->unitarray['u5']; ?>,
                        "6":<?php echo $village->unitarray['u6']; ?>,
                        "7":<?php echo $village->unitarray['u7']; ?>,
                        "8":<?php echo $village->unitarray['u8']; ?>,
                        "9":<?php echo $village->unitarray['u9']; ?>,
                        "10":<?php echo $village->unitarray['u10']; ?>,
                        "11":<?php echo $village->unitarray['u11']; ?>},
                    "directions": {
                        "village": "none",
                        "ew": "none",
                        "distance": "asc",
