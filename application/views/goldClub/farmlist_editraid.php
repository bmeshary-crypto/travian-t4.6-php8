...
if (!in_array($eiddata['lid'], $arrayka)) {
    die("Это не inаш лист,сударь!");
}
$lid2 = $eiddata['lid'];
...
<div id="raidListSlot">
    ...
    <form id="edit_form" action="build.php?id=39&t=99&action=showSlot&eid=<?php echo $_GET['eid']; ?>" method="post">
                        ...
                        <td class="target">
                            ...
                            <div class="coordinatesInput">
                                <div class="xCoord">
                                    ...
                                    <input value="<?php echo $x; ?>" name="x" id="xCoordInput"
                                           class="text coordinates x ">
                                </div>
                                <div class="yCoord">
                                    <label for="yCoordInput">Y:</label>
                                    <input value="<?php echo $y; ?>" name="y" id="yCoordInput"
        ...
        &nbsp;
        <button type="button" value="delete" name="delete" id="delete" class="green textButtonV1" onclick="return (function(){
