...
<div id="raidListSlot">
    ...
    <form action="build.php?id=39&t=99&action=showSlot&lid=<?php echo $_GET['lid']; ?>" method="post">
                        ...
                        <td class="target">
                            ...
                            <div class="coordinatesInput">
                                <div class="xCoord">
                                    ...
                                    <input value="<?php echo $vData['exist'] ? $database->getCoor($_GET['vid'])['x'] : $_POST['x']; ?>"
                                           name="x" id="xCoordInput" class="text coordinates x ">
                                </div>
                                <div class="yCoord">
                                    <label for="yCoordInput">Y:</label>
                                    <input value="<?php echo $vData['exist'] ? $database->getCoor($_GET['vid'])['y'] : $_POST['y']; ?>"
                                           name="y" id="yCoordInput" class="text coordinates y ">
                                </div>
                                <div class="clear"></div>
                            </div>
        ...
        <button type="submit" value="save" name="save" id="save" class="green textButtonV1">
