...
?>
    ...
    <h1 class="titleInHeader"><?php echo $lang['Map'][0]; ?></h1>
    <div class="map2">
                    ...
                    <div class="mr">
                        <div class="mc">
                            <div class="contents">
                                ...
                                <?php // this need plus ?>
                                <div class="iconButton <?php if (isset($_GET['fullscreen'])) {
                                    echo 'viewNormal checked';
                                } else {
                                    echo 'viewFull';
                                } ?>"></div>
                            ...
                            <div class="contents">
                                <div class="coordinatesInput">
                                    <div class="xCoord">
                                        ...
                                        <input value="<?php echo $x; ?>" name="x" id="xCoordInputMap"
                                               class="text coordinates x ">
                                    </div>
                                    <div class="yCoord">
                                        <label for="yCoordInputMap">Y:</label>
                                        <input value="<?php echo $y; ?>" name="y" id="yCoordInputMap"
                                               class="text coordinates y ">
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                <button type="submit" class="green small" id="buttonSfiBQehEAoQ1M">
                                    <div class="button-container addHoverClick">
                                        ...
                                        <div class="button-content"><?php echo $lang['Map'][2]; ?></div>
                                    </div>
                                </button>
            ...
            <div id="outline">
                ...
                <div id="mapMarks">
                    ...
                    <div class="tabContainer" style="display: none;">
                        ...
                        <div id="tabPlayer" class="dataTab">
                            <div class="collapseContainer">
                                <div class="title"><?php echo $lang['Map'][4]; ?> <a href="#"
                                                                                     class="add addButton">+</a></div>
                                <div class="iconButton expandButton small expand"></div>
                                <div class="clear"></div>
                                <div class="expandContainer" style="height: 0px;">
                                    <div class="jScroll">
                                        <div class="jScroll-content" style="height: auto; margin-top: 0px;">
                                            <div class="dataContainer"></div>
                                        </div>
                                        <div class="jScroll-scroll jScroll-element-scroll" style="display: none;">
                                            <div class="jScroll-scroll-up">
                                                <div class="jScroll-element-up"></div>
                                            </div>
                                            <div class="jScroll-scroll-between jScroll-element-between"></div>
                                            <div class="jScroll-scroll-slider jScroll-element-slider">
                                                <div class="jScroll-element-slider top"></div>
                                                <div class="jScroll-element-slider center"></div>
                                                <div class="jScroll-element-slider bottom"></div>
                                            </div>
                                            <div class="jScroll-scroll-between jScroll-element-between"></div>
                                            <div class="jScroll-scroll-down">
                                                <div class="jScroll-element-down"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="collapseContainer">
                                <div class="title">Player: <a href="#" class="add addButton">+</a></div>
                                <div class="iconButton expandButton small expand"></div>
                                <div class="clear"></div>
                                <div class="expandContainer" style="height: 0px;">
                                    <div class="jScroll">
                            ...
                            <div class="collapseContainer">
                                <div class="title">Flags <a href="#" class="add addButton">+</a></div>
                                <div class="iconButton expandButton small collapse"></div>
                                <div class="clear"></div>
                                <div class="expandContainer" style="height: 0px;">
                                    <div class="jScroll">
                                        <div class="jScroll-content" style="height: auto; margin-top: 0px;">
