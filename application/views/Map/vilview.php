...
<span class="clear">&nbsp;</span></h1>
    ...
    <h1 class="titleInHeader"><?php if ($basearray['fieldtype'] != 0) {
        ...
        if ($basearray['occupied'] && $basearray['capital']) {
            echo " <small><span class=\"a disabled\"><small>(" . OVERVIEW20 . ")</small></span></small>";
        } ?><span class="clear">&nbsp;</span></h1>
    <div id="tileDetails"
        ...
        <div id="map_details">
			...
			<td><a href="allianz.php?aid=' . $uinfo['alliance'] . ' ">' . $database->RemoveXSS($database->getUserAlliance($oasis['owner'])) . '</a></td>'; ?>
                    ...
                    <tr>
                        ...
                        <td><a href="spieler.php?uid=<?php echo $oasis['owner']; ?>"><?php if ($oasis['owner'] != 2) {
                    ...
                    <tr>
                        <th>Village:</th>
                        <td>
                            <a href="karte.php?d=<?php echo $oasis['conqured']; ?>&c=<?php echo $generator->getMapCheck($oasis['conqured']); ?>"><?php echo $database->RemoveXSS($database->getVillageField($oasis['conqured'], "name")); ?></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
