<?php
$getd = $database->getBaseID($x, $y);
$basearray = $database->getMInfo($getd);
if ($basearray['type_of'] != '' && $basearray['oasistype'] == 0) {
    ?>
    <h1 class="titleInHeader"><?= logint43 ?> <span class="coordinates coordinatesWrapper"><span
                    class="coordinateX"><?php echo "(" . $basearray['x'] . ""; ?></span><span
                    class="coordinatePipe">|</span><span
                    class="coordinateY"><?php echo "" . $basearray['y'] . ")"; ?></span>
<span class="clear">&nbsp;</span></h1>
    <div id="tileDetails" class="landscape landscape-<?= $basearray['type_of'] ?>">
        <div class="detailImage">
            <div class="options">
                <div class="option"><a href="karte.php?x=<?= $basearray['x'] ?>&y=<?= $basearray['y'] ?>"
                                       class="a arrow"><?= logint410 ?></a></div>
            </div>
        </div>
        <div class="clear"></div>
        <div class="clear"></div>
...
<div id="tileDetails"
     class="village <?php echo ($basearray['fieldtype'] == 0) ? 'oasis-' . $map->oasisphoto($basearray['oasistype']) : 'village-' . $basearray['fieldtype'] ?>">
    <h1><?php if ($basearray['fieldtype'] != 0) {
            $basearray['name'] = $database->RemoveXSS($basearray['name']);
            echo !$basearray['occupied'] ? KAR1 : $basearray['name'];
            ...
            echo $oasisname;
            ?>
            <span class="coordinates coordinatesWrapper"><span class="coordinateX"><?php echo "( " . $basearray['x'] . " "; ?></span><spanclass="coordinatePipe">|</span><span class="coordinateY"><?php echo " " . $basearray['y'] . " )"; ?></span></span>
            <?php
        }
        if ($basearray['occupied'] && $basearray['capital']) {
            echo "<span class=\"mainVillage\">(" . OVERVIEW20 . ")</span>";
        } ?><span class="clear">&nbsp;</span></h1>
    <div class="detailImage">
        <div id="options">
            <div class="option"><a href="karte.php?x=<?php echo $basearray['x']; ?>&y=<?php echo $basearray['y']; ?>"
                                   class="a arrow"><?= logint410 ?></a></div>
            <?php if (!$basearray['occupied']) { ?>
                <div class="option">
                    ...
                    echo ($basearray['fieldtype'] == 0) ? ($village->resarray['f39'] == 0) ?
                        ...
                        "<a class=\"a arrow " . ($userDataOasis['protect'] && $xx == 0 && $xx == 0 ? 'disabled' : '') . "\" target=\"_top\" " . (!$userDataOasis['protect'] || $xx != 0 ? "href=\"build.php?t=2&id=39&z=" . $getd . "\"" : '') . "> " . ($userDataOasis['protect'] && $xx == 0 ? KAR10 : KAR9) . " 
            ...
            <?php } else if ($basearray['occupied'] == 1 && $basearray['oasistype'] == 0 && $basearray['wref'] != $_SESSION['wid']) {
                ...
                <div class="option">
                    ...
                    if ($uinfo['access'] == '0' || $uinfo['access'] == '8' || $uinfo['access'] == '9') {
                        ...
                        if ($session->protection > time()
                            ...
                            && $uinfo['id'] != 4
                            && $uinfo['id'] != 3) {
                            echo '<span class="a arrow disabled" title="No way you can do this, you re still under protection</span>';
                        } else {
                ...
                <div class="option">
                    ...
                    if ($uinfo['access'] == '0' || $uinfo['access'] == '8' || $uinfo['access'] == '9') {
                        ...
                        echo($village->resarray['17']);
                        echo $database->getTypeLvlFdata(17, $village->resarray) ? "<a class=\"a arrow\" target=\"_top\" href=\"build.php?z=" . $getd . "&id=" . $database->getTypeField(17, $village->resarray) . "&t=5\"> " . KAR11 . "</a>" : "<span class=\"a arrow disabled\"> " . KAR11 . " (" . KAR17 . ")</span>";
                    }
                    ?>
            ...
            <?php } else if ($basearray['occupied'] == 1 && $basearray['oasistype'] != 0 && $basearray['wref'] != $_SESSION['wid']) { ?>
                ...
                <div class="option">
                    <?php
                    echo $village->resarray['f39'] ? "<a class=\"a arrow\" target=\"_top\" href=\"build.php?t=2&id=39&z=" . $d . "\">" . logint419 . "</a>" : "<span class=\"a arrow disabled\" title=\"(Build a rally point)\"><?=logint419?></span>";
                    ?>
                </div>
            <?php } ?>
            <br>
                ...
                <div class="option">
                    ...
                    if ($fList['id']) {
                        if (($uinfo['ptime'] > time() || $uinfo['protect'] == 1)) {
                            ...
                            ?>
                            <a href="build.php?id=39&t=99&action=showSlot&lid=1&vid=<?php echo $getd; ?>&sort=distance&direction=asc"><span
                                        class="a arrow GoldClub">Add a farm to the list</span></a>
                        <?php }
                    } else { ?>
                        <span class="a arrow disabled" title="Create a list of farms first From a collection point">Add a farm to the list</span></span>
    ...
    <div id="map_details">
        ...
        <?php if ($uinfo['id'] != 2 && !$basearray['fieldtype'] && $database->getOasisInfo($basearray['id'])['conqured']) { // iRedux - Fixed ?>
			...
			<td><a target=\"_top\" href="allianz.php?aid=' . $uinfo['alliance'] . ' ">' . $database->RemoveXSS($database->getUserAlliance($oasis['owner'])) . '</a></td>'; ?>
                </tr>
                <tr>
                    <th><?php echo OVERVIEW1; ?></th>
                    <td><a target="_top"
                           href="spieler.php?uid=<?php echo $oasis['owner']; ?>"><?php if ($oasis['owner'] != 2) {
                                echo $database->RemoveXSS($database->getUserField($oasis['owner'], 'username', 0));
                            } else {
                                echo "Nature";
                            } ?></a></td>
                </tr>
                <tr>
                    <th>Village:</th>
                    <td><a target="_top"
                           href="karte.php?d=<?php echo $oasis['conqured']; ?>&c=<?php echo $generator->getMapCheck($oasis['conqured']); ?>"><?php echo $database->RemoveXSS($database->getVillageField($oasis['conqured'], "name")); ?></a>
                    </td>
                </tr>
                </tbody>
            </table>
...
<td><i class=\"r4\"></i> 6</td>";
                    ...
                    case 0:
                        ...
                        <td class=\"val\">25%</td>
                        <td class=\"desc\">" . LUMBER . "</td>";
                                break;
                            case 2:
                                $tt = "<td class=\"ico\"><i class=\"r1\"></i></td>
                        <td class=\"val\">50%</td>
                        <td class=\"desc\">" . LUMBER . "</td>";
                                break;
                            case 3:
                        ...
                        <td class=\"val\">25%</td>
                        <td class=\"desc\">" . IRON . "</td></tr>

                        <tr><td class=\"ico\"><i class=\"r4\"></i></td>
                        <td class=\"val\">25%</td>
                        <td class=\"desc\">" . CROP . "</td></tr>";
                                break;
                            case 10:
                            case 11:
                                $tt = "
        ...
        <?php if ($basearray['fieldtype'] == 0 && !$oasis['conqured']) {
			...
			<td><a target=\"_top\" href="allianz.php?aid=' . $uinfo['alliance'] . '">' . $database->getUserAlliance($basearray['owner']) . '</a></td>'; ?>
                ...
                <tr>
                    <th><?= logint416 ?></th>
                    <td><a target="_top"
                           href="spieler.php?uid=<?php echo $basearray['owner']; ?>"><?php echo $uinfo['username']; ?></a>
                    </td>
                </tr>
                <tr>
                    <th><?= logint417 ?></th>
            ...
            <div class="contentNavi tabNavi tabSubWrapper">
                <div title="" class="container active">
                    ...
                    <div class="content">
                        ...
                        <a id="buttonC1" href="#"" class="tabItem">
                        Reports                                                                </a>
                    </div>
                </div>
                ...
                <script type="text/javascript">
                    if (jQuery('#buttonC1')) {
                        jQuery('#buttonC1').click(function (event) {
                ...
                <script type="text/javascript">
                    if (jQuery('#buttong2')) {
                        jQuery('#buttong2').click(function (event) {
                            jQuery(window).trigger('tabClicked', [this, {
                                "class": "normal",
                                "title": false,
                                "target": false,
                ...
                <table cellpadding="0" cellspacing="0" id="troop_info" class="rep transparent">
                    ...
                    <?php if ($query != 0){
                        foreach ($result as $row) {
                            ...
                            echo "<a target=\"_top\" href=\"berichte.php?id=" . $row['id'] . "\">" . $date[0] . " " . date('H:i', $row['time']) . "</a> ";
                            echo "</td></tr>";
                        }
                    }else{
                    ?>
