...
<div id="write_content" class="msg_content">
    <form method="post" action="nachrichten.php?t=1<?php echo $_GET['id'] ? '&id=' . $_GET['id'] . '' : ''; ?>"
                    ...
                    <div class="paperContent">
                        ...
                        <div id="recipient">
                            ...
                            <div class="header text">
                                ...
                                <button title="Ally" type="button" value="ally" id="ally" class="icon" tabindex="6"
                                        onclick="this.form.receiver.value='[ally]';">
                                    <div class="clear"></div>
                        ...
                        <div id="subject">
                            ...
                            <div class="header text"><input tabindex="2" class="text" maxlength="50" name="be"
                                                            id="subject" type="text" value="<?php
                                ...
                                <div class="boxes boxesColor gray">
                                    ...
                                    <div class="boxes-contents cf">
                                        <div id="message_toolbar" class="bbToolbar">
                                            ...
                                            <button type="button"
                                                    class="icon bbButton bbAlliance bbType{d} bbTag{alliance}"
                                                    title="alliance">
                                            ...
                                            <button type="button"
                                                    class="icon bbButton bbCoordinate bbType{d} bbTag{x|y}"
                                                    title="Coordinates">
                                            ...
                                            <button type="button" id="message_resourceButton"
                                                    class="icon bbWin{resources} bbButton bbResource" title="Resources">
                                            ...
                                            <button type="button" id="message_troopButton"
                                                    class="icon bbWin{troops} bbButton bbTroops" title="Forces">
                                                <img src="img/x.gif" class="bbTroops" alt="bbTroops">
                                            </button>
                                            <button type="button" id="message_previewButton"
                                                    class="icon bbButton bbPreview" title="Preview">
                        ...
                        <div id="send">
                            <button type="submit" value="send" name="s1" id="btn_ok" class="green ">
                                <div class="button-container addHoverClick ">
                                    ...
                                    <div class="button-content"><?= MSG13 ?></div>
                                </div>
                            </button>
