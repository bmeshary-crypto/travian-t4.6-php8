...
<div class="cf">
    ...
    <h1 class="titleInHeader"><img class="gebIcon g<?php echo $idBuild; ?>Icon" src="img/x.gif"
                                   alt="<?= $lang['buildings'][$idBuild]; ?>"> <?= $lang['buildings'][$idBuild]; ?></h1>
    ...
    <div class="inlineIconList resourceWrapper">
        <div class="inlineIcon resource"><i class="r1Big"></i><span
                    class="value value"><?php echo ${'bid' . $idBuild}[1]['wood']; ?></span></div>
        <div class="inlineIcon resource"><i class="r2Big"></i><span
                    class="value value"><?php echo ${'bid' . $idBuild}[1]['clay']; ?></span></div>
        <div class="inlineIcon resource"><i class="r3Big"></i><span
                    class="value value"><?php echo ${'bid' . $idBuild}[1]['iron']; ?></span></div>
        <div class="inlineIcon resource"><i class="r4Big"></i><span
                    class="value value"><?php echo ${'bid' . $idBuild}[1]['crop']; ?></span></div>
        <div class="inlineIcon resource"><i class="cropConsumptionBig"></i><span
                    class="value value"><?php echo ${'bid' . $idBuild}[1]['pop']; ?></span></div>
    </div>
    <br>
    <div class="inlineIcon duration"><i class="clock_medium"></i><span
                class="value "><?php echo $generator->getTimeFormat(round((${'bid' . $idBuild}[1]['time'] / SPEED), 5)); ?></span>
    </div>
