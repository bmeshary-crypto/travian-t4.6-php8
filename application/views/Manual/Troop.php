...
<div class="cf">
    ...
    <h1 class="titleInHeader">
        <img class="unit u<?php echo $idTroop; ?>" src="img/x.gif"
             alt="<?php echo $technology->getUnitName($idTroop); ?>"> <?php echo $technology->getUnitName($idTroop); ?>
        <span class="tribe">(<?php echo $tribe; ?>)</span>
    </h1>

    <div class="bigUnitSection">
        <img class="unitSection u<?php echo $idTroop; ?>Section" src="img/x.gif"
             alt="<?php echo $technology->getUnitName($idTroop); ?>">
    </div>
                ...
                <tr>
                    <td>
                        <div class="inlineIconList resourceWrapper">
                            <div class="inlineIcon resources"><i class="r1"></i><span
                                        class="value "><?php echo ${'u' . $idTroop}['wood']; ?></span></div>
                        </div>
                    </td>
                    <td>
                        <div class="inlineIconList resourceWrapper">
                            <div class="inlineIcon resources"><i class="r2"></i><span
                                        class="value "><?php echo ${'u' . $idTroop}['clay']; ?></span></div>
                        </div>
                    </td>
                    <td>
                        <div class="inlineIconList resourceWrapper">
                            <div class="inlineIcon resources"><i class="r3"></i><span
                                        class="value "><?php echo ${'u' . $idTroop}['iron']; ?></span></div>
                        </div>
                    </td>
                    <td class="last">
                        <div class="inlineIconList resourceWrapper">
                            <div class="inlineIcon resources"><i class="r4"></i><span
                                        class="value "><?php echo ${'u' . $idTroop}['crop']; ?></span></div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <img class="att_all" src="img/x.gif" alt="Dead force"><?php echo ${'u' . $idTroop}['atk']; ?>
                    </td>
                    <td>
                        <img class="def_i" src="img/x.gif"
                             alt="Power time against"><?php echo ${'u' . $idTroop}['di']; ?></td>
                    <td>
                        <img class="def_c" src="img/x.gif"
                             alt="Power time against"><?php echo ${'u' . $idTroop}['dc']; ?></td>
                    <td>
                    </td>
                </tr>
                </tbody>
        ...
        <div class="boxes-contents cf">
            <table class="troopData" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <td>
                        <div class="inlineIconList resourceWrapper">
                            <div class="inlineIcon resources"><i class="r5"></i><span
                                        class="value "><?php echo ${'u' . $idTroop}['pop']; ?></span></div>
                        </div>
                    </td>
                </tr>
                <tr>
