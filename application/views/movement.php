...
<div class="movements <?php echo $class ?>">
    ...
    <thead>
    <tr>
        <th colspan="3"><?php echo TROOP_MOVEMENTS; ?></th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    for ($i = 0; $i < $aantal4; $i++) {
        if (($aantal55[$i]['attack_type'] == 1) or ($aantal55[$i]['attack_type'] == 3) or ($aantal55[$i]['attack_type'] == 4) or ($aantal55[$i]['attack_type'] == 5)) {
            $lala -= 1;
        }
    }
    $aantal = $aantal + $lala;
    ...
    for ($i = 0; $i < $aantal1; $i++) {
        ...
        if ($aantal2[$i]['attack_type'] == 1) {
            $aantal -= 1;
        }
        if ($aantal2[$i]['attack_type'] == 5) {
            $aantal -= 1;
        }
    }
    ...
    $aantal2 = $aantal11;
    for ($i = 0; $i < $aantal; $i++) {
        if (($aantal2[$i]['attack_type'] == 1) or ($aantal2[$i]['attack_type'] == 3 or $aantal2[$i]['attack_type'] == 5) or ($aantal2[$i]['attack_type'] == 4)) {
            $lala -= 1;
        }
    }
    if ($lala > 0) {
        if (!empty($NextArrival3)) {
            reset($NextArrival3);
        }
        foreach ($aantal2 as $receive) {
            if ($receive['attack_type'] == 2) {
