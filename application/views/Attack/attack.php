...
<form method="post" action="build.php?t=2&id=39">
    ...
    <table id="short_info" cellpadding="1" cellspacing="1">
        ...
        <tr>
            ...
            <td><a href="karte.php?d=<?php $d = $database->getBaseID($coor['x'], $coor['y']);
                echo $d . "&c=" . $generator->getMapCheck($d); ?>"><?php echo $process[1]; ?> (<?php echo $coor['x']; ?>
                    |<?php echo $coor['y']; ?>)</a></td>
    ...
    <table class="troop_details" cellpadding="1" cellspacing="1">
        ...
        <tr>
            ...
            <td colspan="<?php if ($process['t11'] != '') {
                ...
                echo "10";
            } ?>"><?php echo $actionType . "  " . $process['1']; ?></td>
        ...
        <tr>
            ...
            <td
            <?php if (!isset($process['t1']) || $process['t1'] == '') {
                echo "class=\"none\">0";
            } else {
                echo ">" . $process['t1'];
            } ?></td>
            ...
            <td
            <?php if (!isset($process['t2']) || $process['t2'] == '') {
                echo "class=\"none\">0";
            } else {
                echo ">" . $process['t2'];
            } ?></td>
            ...
            <td
            <?php if (!isset($process['t3']) || $process['t3'] == '') {
                echo "class=\"none\">0";
            } else {
                echo ">" . $process['t3'];
            } ?></td>
            ...
            <td
            <?php if (!isset($process['t4']) || $process['t4'] == '') {
                echo "class=\"none\">0";
            } else {
                echo ">" . $process['t4'];
            } ?></td>
            ...
            <td
            <?php if (!isset($process['t5']) || $process['t5'] == '') {
                echo "class=\"none\">0";
            } else {
                echo ">" . $process['t5'];
            } ?></td>
            ...
            <td
            <?php if (!isset($process['t6']) || $process['t6'] == '') {
                echo "class=\"none\">0";
            } else {
                echo ">" . $process['t6'];
            } ?></td>
            ...
            <td
            <?php if (!isset($process['t7']) || $process['t7'] == '') {
                echo "class=\"none\">0";
            } else {
                echo ">" . $process['t7'];
            } ?></td>
            ...
            <td
            <?php if (!isset($process['t8']) || $process['t8'] == '') {
                echo "class=\"none\">0";
            } else {
                $kata = '1';
                echo ">" . $process['t8'];
            ...
            <td
            <?php if (!isset($process['t9']) || $process['t9'] == '') {
                echo "class=\"none\">0";
            } else {
                echo ">" . $process['t9'];
            } ?></td>
            ...
            <td
            <?php if (!isset($process['t10']) || $process['t10'] == '') {
                echo "class=\"none\">0";
            } else {
                echo ">" . $process['t10'];
            } ?></td>

            <?php if (!isset($process['t11']) || $process['t11'] == '') {
                echo "";
            } else {
            ...
            <?php if (!$database->isVillageOases($d)) { ?>
                <tr>
                    ...
                    <td colspan="<?php if ($process['t11'] != '') {
                        ...
                        echo "10";
                    } ?>"><input class="radio" name="spy" value="1" checked="checked"
                                 type="radio"><?php echo OTPRAV10; ?>
        ...
        <tr>
            ...
            if ($process['t11'] > 0) {
                ...
                if ($session->alliance > 0 && $session->alliance == $process['3']) {
                    $bon = $bonuses['ally'];
                } else {
                    $bon = 1;
                }
                if ($session->uid == $from['2']) {
                    $bon2 = $bonuses['own'];
                } else {
                    $bon2 = 1;
                }
            ...
            ?>
            <td colspan="<?php if ($process['t11'] > 0) {
                echo "11";
            } else {
                echo "10";
            } ?>">
                <div class="in"><?php echo $generator->getTimeFormat($time); ?></div>
                <div class="at"><?php echo REPORT_AT; ?><span
                            id="tp2"> <?php echo $generator->procMtime(date('U') + $time, 9) ?></span></div>
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <button type="submit" value="ok" name="s1" id="btn_ok" class="green textButtonV1 ">
        <div class="button-container addHoverClick">
            ...
            <div class="button-content"><?= punktxuev3 ?></div>
        </div>
    </button>
</form>
