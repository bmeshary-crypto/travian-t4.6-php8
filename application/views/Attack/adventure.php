...
<div id="tileDetails" class="landscape landscape-<?= $adventure['type_of'] ?>">
    ...
    <br>
    <?php echo $lang['Hero']['adv02']; ?>
    : <?php echo $generator->getTimeFormat($time); ?> <?php echo $lang['Hero']['adv04']; ?>
    | <?php echo $lang['Hero']['adv03']; ?>
    : <?php echo $generator->getTimeFormat($time * 2); ?> <?php echo $lang['Hero']['adv04']; ?>
    <br>
    <br>
        ...
        <div class="adventureSendButton">
            ...
            <form class="adventureSendButton" method="post" action="build.php?t=2&id=39">
                <div>
                    ...
                    <button <?php if ($heroF->getHeroStatus() == 100) {
                        echo 'type="submit"';
                    } ?> value="<?php echo $lang['Hero']['adv05']; ?>" name="s1" id="start" class="green textButtonV1">
