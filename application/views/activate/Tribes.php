<div id="contentOuterContainer" class="size1">
    ...
    <div class="contentContainer">
        <div id="content" class="activate">
            ...
            <h1 class="titleInHeader"><?php echo $lang['Register']['00']; ?></h1>
            <div class="activationScreen">
                ...
                <form method="post" action="">
                    <div id="presentation">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 540 250">
                            ...
                            <g class="descriptionBoxWithArrow">
                                <path class="outer" d="M10 10 V230 H63.20028200282003 l20 20 l20 -20 H530 V10 Z"
                                      data-original="M10 10 V230 H20 l20 20 l20 -20 H530 V10 Z"></path>
                                <path class="inner" filter="url(#inset)"
                                      d="M10 10 V230 H63.20028200282003 l20 20 l20 -20 H530 V10 Z"
                                      data-original="M10 10 V230 H20 l20 20 l20 -20 H530 V10 Z"></path>
                            </g>
                        </svg>
                    ...
                    <div class="buttonContainer">
                        <button type="submit" value="<?php echo $lang['Register']['Confirm']; ?>"
                                id="buttonEdtoC6b43XVyv" class="orange textButtonV1 confirmation">
                                ...
                                if ($('buttonEdtoC6b43XVyv')) {
                                    $('buttonEdtoC6b43XVyv').addEvent('click', function () {
                                        window.fireEvent('buttonClicked', [this, {
                                            "type": "submit",
                                            "value": "<?php echo $lang['Register']['Confirm']; ?>",
                                            "name": "",
                                            "id": "buttonEdtoC6b43XVyv",
                                            "class": "orange ",
                                            "title": "",
                                            "confirm": "",
                                            "onclick": ""
            ...
            <div id="tpixeliframe_loading"
                 style="display: none; z-index: 1000; position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; background-color: rgb(0, 0, 0); opacity: 0.4;"></div>
            <script type="text/javascript">
                //<!--
