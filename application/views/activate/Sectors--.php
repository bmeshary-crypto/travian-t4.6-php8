                ...
                <div class="contentContainer">
                    <div id="content" class="activate">
                        <h1 class="titleInHeader"style="    margin-left: 144px;
    width: 596px;"><?php echo $lang['Register']['27']; ?></h1><a id="backButton" class="contentTitleButton" href="activate.php?page=vid"></a>
