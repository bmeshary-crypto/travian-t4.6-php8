<div id="contentOuterContainer" class="size1">
    ...
    <div class="contentContainer">
        <div id="content" class="activate">
            ...
            <h1 class="titleInHeader withBackButton"><?php echo $lang['Register']['27']; ?></h1>
                <a id="backButton" class="contentTitleButton buttonFramed green withIcon rectangle" href="activate.php?page=vid">
                ...
                <form method="post" action="activate.php?page=sector">
                    ...
                    <div id="presentation" class="sectors">
                        ...
                        <div id="activationMapContainer">
                            ...
                            <div id="map" class="">
                                ...
                                <label for="sector_sw"
                                       data-text="<?php echo $lang['Register']['SRECOMMENDED']; ?>"><?php echo $lang['Register']['32']; ?></label>
                    ...
                    <div class="buttonContainer">
                        <button type="submit" value="<?php echo $lang['Register']['Confirm']; ?>"
                                id="buttonGmBfOvFRA0upi" class="orange textButtonV1 confirmation">
