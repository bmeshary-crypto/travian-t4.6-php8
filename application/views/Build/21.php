    ...
    if ($building->getTypeLevel(21) > 0) { ?>
        <form method="POST" name="snd" action="build.php">
            ...
            <div class="buildActionOverview trainUnits">
                ...
                ?>
                            <button type="button" class="textButtonV3 gold exchange <?php echo $isDisabled ? 'disabled' : ''; ?>" onfocus="jQuery('button', 'input[type!=hidden]', 'select').focus(); event.stopPropagation(); return false;" id="button<?php echo crc32($i); ?>">
            ...
            <?php if ($success) { ?>
                <button type="submit" class="green startTraining textButtonV3">
                    <div class="button-container addHoverClick ">
                        <div class="button-background">
                            <div class="buttonStart">
                                <div class="buttonEnd">
