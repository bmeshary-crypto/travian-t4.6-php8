    ...
    <div class="boxes boxesColor gray search_select">
        ...
        <div class="boxes-contents">
            <table id="search_select" class="buy_select transparent" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td>
                        <button type="button" value="r1Big"
                                title="<?php echo $lang['dorf']['D1']; ?>" <?php if (isset($_GET['s']) && $_GET['s'] == 1) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&s=1<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><i class="r1"></i>
                        </button>
                    </td>
                    <td>
                        <button type="button" value="r2Big"
                                title="<?php echo $lang['dorf']['D2']; ?>" <?php if (isset($_GET['s']) && $_GET['s'] == 2) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&s=2<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><i class="r2"></i>
                        </button>
                    </td>
                    <td>
                        <button type="button" value="r3Big"
                                title="<?php echo $lang['dorf']['D3']; ?>" <?php if (isset($_GET['s']) && $_GET['s'] == 3) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&s=3<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><i class="r3"></i>
                        </button>
                    </td>
                    <td>
                        <button type="button" value="r4Big"
                                title="<?php echo $lang['dorf']['D4']; ?>" <?php if (isset($_GET['s']) && $_GET['s'] == 4) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&s=4<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><i class="r4"></i>
                        </button>
                    </td>
                </tr>
                </tbody>
        ...
        <div class="boxes-contents">
            <table id="ratio_select" class="buy_select transparent" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td>
                        <button type="button"
                                value="marketPercentage marketPercentage1_1" <?php if (isset($_GET['v'])) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&v=1:1<?php if (isset($_GET['s'])) echo "&s=" . $_GET['s'];
                                if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;">
                            <img src="img/x.gif" class="marketPercentage marketPercentage1_1"
                                 alt="marketPercentage marketPercentage1_1"></button>
                    </td>
                </tr>
                <tr>
                    <td>
                        <button type="button"
                                value="marketPercentage marketPercentage1_x" <?php if (!isset($_GET['v'])) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1<?php if (isset($_GET['s'])) echo "&s=" . $_GET['s'];
                                if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;">
                            <img src="img/x.gif" class="marketPercentage marketPercentage1_x"
                                 alt="marketPercentage marketPercentage1_x"></button>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="boxes-contents">
            <table id="bid_select" class="buy_select transparent" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td>
                        <button type="button" value="r1Big"
                                title="<?php echo $lang['dorf']['D1']; ?>" <?php if (isset($_GET['b']) && $_GET['b'] == 1) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&b=1<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                if (isset($_GET['s'])) echo "&s=" . $_GET['s']; ?>'; return false;">
                            <i class="r1"></i></button>
                    </td>
                    <td>
                        <button type="button" value="r2Big"
                                title="<?php echo $lang['dorf']['D2']; ?>" <?php if (isset($_GET['b']) && $_GET['b'] == 2) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&b=2<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                if (isset($_GET['s'])) echo "&s=" . $_GET['s']; ?>'; return false;">
                            <i class="r2"></i></button>
                    </td>
                    <td>
                        <button type="button" value="r3Big"
                                title="<?php echo $lang['dorf']['D3']; ?>" <?php if (isset($_GET['b']) && $_GET['b'] == 3) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&b=3<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                if (isset($_GET['s'])) echo "&s=" . $_GET['s']; ?>'; return false;">
                            <i class="r3"></i></button>
                    </td>
                    <td>
                        <button type="button" value="r4Big"
                                title="<?php echo $lang['dorf']['D4']; ?>" <?php if (isset($_GET['b']) && $_GET['b'] == 4) {
                            echo "class=\"iconFilter iconFilterActive\"";
                        } else {
                            echo "class=\"iconFilter\"";
                        } ?>
                                onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&b=4<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                if (isset($_GET['s'])) echo "&s=" . $_GET['s']; ?>'; return false;">
                            <i class="r4"></i></button>
                    </td>
                </tr>
        ...
        for ($i = 0 + $u; $i <= 40 + $u; $i++) {
            if (isset($market->onsale[$i])) {
                ...
                if (($market->onsale[$i]['wtype'] == 1 && $village->awood <= $market->onsale[$i]['wamt']) || ($market->onsale[$i]['wtype'] == 2 && $village->aclay <= $market->onsale[$i]['wamt']) || ($market->onsale[$i]['wtype'] == 3 && $village->airon <= $market->onsale[$i]['wamt']) || ($market->onsale[$i]['wtype'] == 4 && $village->acrop <= $market->onsale[$i]['wamt'])) {
                    echo "<td class=\"act none\">" . market9 . "</td></tr>";
                } else if ($reqMerc > $market->merchantAvail()) {
                    echo "<td class=\"act none\">" . market10 . "</td></tr>";
                } else {
...
<div class=\"button-container addHoverClick \">
    ...
    </div><div class=\"button-content\">" . market11 . "</div></div></button></a></td>";
                }
                echo "</tr>";
            }
        }
    } else {
        echo "<tr><td class=\"none\" colspan=\"5\">" . market12 . "</td></tr>";
    }
    ?>
    </tbody>
</table>
