        ...
        <table id="target_validate" class="res_target" cellpadding="1" cellspacing="1">
            <tbody>
                <tr>
                    ...
                    ?>
                    <td class="vil"><a href="karte.php?d=<?php echo $getwref; ?>&c=<?php echo $generator->getMapCheck($getwref); ?>"><?php echo $getvilname; ?>
...
?>
    <form method="POST" name="snd" action="build.php">
        ...
        <p>
            <button type="submit" value="ok" name="s1" id="btn_ok" class="textButtonV3 green prepare <?php if (!$session->right['s3']) {
                                                                                                            echo 'disabled';
                                                                                                        } ?>" tabindex="8">
                <div class="button-container addHoverClick">
                    <div class="button-background">
