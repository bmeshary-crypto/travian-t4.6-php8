...
if ($village->resarray['f' . $id] >= 10) {
    ?>
    <h4 class="round">Demolish buildings:</h4>
    <p>If you do not need a building, you can demolish it from here:</p>
    ...
    if (!empty($DemolitionProgress)) {
        ...
        ?>
        <a href="?buildingFinish=1" onclick="return confirm <?= gz3 ?>;"
           title="Finish all construction and research orders in this village immediately for 2 Gold?"><img
                    class="clock"
        ...
        echo "</select>";
        echo "";
        echo " <button type=\"submit\"  id=\"btn_demolish\" class=\"textButtonV3 green\"> <div class=\"button-container addHoverClick\">
  ...
  <div class=\"button-content\">" . gz4 . "</div></div></button>";
        ...
        <div class="demolishNow">
            <button type="button" class="textButtonV3 gold " coins="<?php echo DEMOLISH_FULL; ?>" id="buttonRIqnOWSTsTeLO">
                <div class="button-container addHoverClick">
                    ...
                    <div class="button-content">Completely demolished<img src="img/x.gif" class="goldIcon" alt=""><span
                                class="goldValue"><?php echo DEMOLISH_FULL; ?></span></div>
                </div>
            </button>
                    ...
                    if ($('buttonRIqnOWSTsTeLO')) {
                        $('buttonRIqnOWSTsTeLO').addEvent('click', function () {
                            window.fireEvent('buttonClicked', [this, {
                                ...
                                "title": "\u0647\u062f\u0645 \u0627\u0644\u0645\u0628\u0646\u0649 \u0627\u0644\u0645\u062d\u062f\u062f \u061f \u0633\u064a\u062a\u0645 \u062d\u0630\u0641\u0647 \u0646\u0647\u0627\u0626\u064a\u0627\u064b \u0645\u0646 \u0627\u0644\u0642\u0631\u064a\u0629",
                                "coins": 2,
                                "id": "buttonRIqnOWSTsTeLO"
                            }]);
                        });
                    }
                });
