...
<div class="contentNavi subNavi tabFavorWrapper">
    ...
    <div class="scrollingContainer">
        ...
        <div class="content favor favorKey0">
            <a id="buttonx1" href="build.php?id=<?php echo $id; ?>&category=1" class="tabItem <?php if($t==1){echo 'active';}else{echo 'normal';}?>" >
                Infrastructure
            </a>
        </div>

        <div class="content favor favorKey2 ">
            <a id="buttonw2" href="build.php?id=<?php echo $id; ?>&category=2" class="tabItem <?php if($t=2){echo 'active';}else{echo 'normal';}?>" >
                Army buildings
            </a>
        </div>
        <div class="content favor favorKey3 ">
            <a id="buttonL3" href="build.php?id=<?php echo $id; ?>&category=3" class="tabItem <?php if($t=3){echo 'active';}else{echo 'normal';}?>" >
                Resource buildings
            </a>
        </div>
    </div>
    ...
    <div class="buildingWrapper">
        ...
        <div class="build_desc">
            <a href="#" onclick="return Travian.Game.iPopup(<?php echo $i; ?>,4);" class="build_logo">
                <img class="build_logo building big white g<?php echo $i; ?> <?php echo $tribeCss ?>" src="img/x.gif"
                     alt="<?= $lang['buildings'][$i] ?>">
            </a>
            <?= $lang['desc'][$i][0] ?>
        </div>
...
<?php
    ...
    if ($id == 39 || $id == 40) {
        ...
        <div class="buildingWrapper">
            ...
            <div class="build_desc">
                <a href="#" onclick="return Travian.Game.iPopup(<?php echo $i; ?>,4);" class="build_logo">
                    <img class="build_logo building big white g<?php echo $i; ?> <?php echo $tribeCss ?>"
                         src="img/x.gif" alt="<?= $lang['buildings'][$i] ?>">
                </a>
                <?= $lang['desc'][$i][0] ?>
            </div>
...
if ($x == 0) {
    echo '<div class="none">Buildings cannot be constructed at a time. Most buildings need basic requirements for their construction, see the guide</div>';
}
...
if ($id != 39 && $id != 40) {
                    ...
                    <div id="contract_building<?php echo $i; ?>" class="contract contractNew contractWrapper">
                        <div class="inlineIconList resourceWrapper">
                            <div class="inlineIcon resource"><i class="r1Big"></i><span
                                        class="value value"><?php echo $uprequire['wood']; ?></span></div>
                            <div class="inlineIcon resource"><i class="r2Big"></i><span
                                        class="value value"><?php echo $uprequire['clay']; ?></span></div>
                            <div class="inlineIcon resource"><i class="r3Big"></i><span
                                        class="value value"><?php echo $uprequire['iron']; ?></span></div>
                            <div class="inlineIcon resource"><i class="r4Big"></i><span
                                        class="value value"><?php echo $uprequire['crop']; ?></span></div>
                            <div class="inlineIcon resource"><i class="cropConsumptionBig"></i><span
                                        class="value value"><?php echo $uprequire['pop']; ?></span></div>
                        </div>
                        <div class="lineWrapper">
                            <div class="inlineIcon duration"><i class="clock_medium"></i><span
                                        class="value "><?php echo $generator->getTimeFormat($uprequire['time']); ?></span>
                            </div>
                        </div>
    ...
    if ($x == 0) {
        echo '<div class="none">A collection of buildings was searched. <br> You may upgrade your Own buildings to even higher levels.</div>';
    }
