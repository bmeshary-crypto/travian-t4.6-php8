...
<?php if ($building->getTypeLevel(36) > 0) { ?>
    <form method="POST" name="snd" action="build.php">
                ...
                <div class="action">
                    <div class="details">
                        ...
                        <div class="inlineIconList resourceWrapper">
                            <div class="inlineIcon resource"><i class="r1Big"></i><span class="value value">35</span>
                            </div>
                            <div class="inlineIcon resource"><i class="r2Big"></i><span class="value value">30</span>
                            </div>
                            <div class="inlineIcon resource"><i class="r3Big"></i><span class="value value">10</span>
                            </div>
                            <div class="inlineIcon resource"><i class="r4Big"></i><span class="value value">20</span>
                            </div>
                            <div class="inlineIcon resource"><i class="cropConsumptionBig"></i><span class="value value">0</span></div>
                        </div>
                        <br>
                        <div class="inlineIcon duration"><i class="maxTraps_medium"></i><span class="value "><?php $dur = $generator->getTimeFormat(round(${'u99'}['time'] * ($bid19[$village->resarray['f' . $id]]['attri'] / 100) / SPEED));
                                                                                                                echo ($dur == "00:00:00") ? "00:00:01" : $dur; ?></span></div>
                        <div class="cta">
        ...
        <button type="submit" value="ok" name="s1" id="s1" class="green startTraining textButtonV3">
            <div class="button-container addHoverClick ">
                <div class="button-background">
                    <div class="buttonStart">
                        <div class="buttonEnd">
                ...
                <div class="button-content"><?php echo $lang['Build']['Train']; ?></div>
            </div>
        </button>
