    ...
    <form method="POST" name="snd" action="build.php">
                                                ...
                                                "dialog": {
                                                    ...
                                                    "data": {
                                                        ...
                                                        "defaultValues": {
                                                            ...
                                                            "nr": "1",
                                                            "btyp": "1",
                                                            "r1": <?=((${'u' . (($session->tribe - 1) * 10 + $i)}['wood']))?>,
                                                            "r2": <?=((${'u' . (($session->tribe - 1) * 10 + $i)}['clay']))?>,
                                                            "r3": <?=((${'u' . (($session->tribe - 1) * 10 + $i)}['iron']))?>,
                                                            "r4": <?=((${'u' . (($session->tribe - 1) * 10 + $i)}['crop']))?>,
                                                            "supply": "1",
                                                            "pzeit": 0,
                                                            "max1": 0,
                                                            "max2": 0,
        ...
        <button type="submit" name="s1" id="btn_train" value="ok" class="green startTraining">
            <div class="button-container addHoverClick ">
                ...
                <div class="button-content">Training</div>
            </div>
        </button>
