...
for ($y = 0; $y < $total_for; $y++) {
    ...
    if ($units[$y]['sort_type'] == 3) {
        ...
        $actionType = "Return from captivity ";
        ...
        if ($tryv == true) {
            ...
            $vname = $database->getVillageField($units[$y]['from'], "name");
        }
        ?>
        <table class="troop_details" cellpadding="1" cellspacing="1">
            ...
            <tr>
                ...
                <td colspan="<?php if ($units[$y]['t11'] != 0) {
                    ...
                    <a href="karte.php?d=<?php echo $units[$y]['from'] . "&c=" . $generator->getMapCheck($units[$y]['from']); ?>"><?php echo "Back from " . $vname; ?></a>
                </td>
            </tr>
            </thead>
            <tbody class="units">
    ...
    if (count($oasistroo[$t]) > 0) {
        foreach ($oasistroo[$t] as $oasistroop) {
            ...
            echo "<table class=\"troop_details\" cellpadding=\"1\" cellspacing=\"1\"><thead><tr><td class=\"role\">
                  ...
                  <td colspan=\"10\">";
            echo "<b>Attack on your </b><a href=\"karte.php?d=" . $oasistroop['from'] . "\">Оазис</a>";
            echo "</td></tr></thead><tbody class=\"units\">";
