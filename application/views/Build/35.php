<h4 class="round spacer">List of celebrations</h4>
<table cellpadding="1" cellspacing="1" class="build_details">
    ...
    <tbody>
        ...
        echo "<tr>";
        echo "<td class=\"desc\">";
        echo "<div class=\"tit\">A vacation</div>";
        ...
        if ($session->gold >= 3 && $building->getTypeLevel(17) >= 1) {
            echo '<br><button type="button" class="textButtonV3 gold exchange " onfocus="jQuery(\'button\', \'input[type!=hidden]\', \'select\').focus(); event.stopPropagation(); return false;" id="button11">
        ...
        if ($inuse > $time) {
            echo "<td class=\"act\">
					<div class=\"none\">There is a celebration </div>
					</td></tr>";
            ...
            echo "<td class=\"act\"><div class=\"none\">Lacks<br>resources</div></td></tr>";
        } else {
            echo "</td>";
            echo "<td class=\"act\">";

            echo "<a class=\"research\" href=\"dorf2.php?pivo&wid=$village->wid\">a celebration</a></td></tr>";
        }
...
if ($timeleft > Time()) {
?>
    <h4 class="round spacer">Celebrations are underway</h4>
<?php
    ...
    echo "</span></td>";
    echo "<td>Close in " . date('H:i', $timeleft) . "</td></tr>";
    echo "</table>";
    $timer += 1;
}
?>