    ...
    <table id="oasesOwned" cellpadding="1" cellspacing="1">
        ...
        if ($query > 0) {
            foreach ($sql as $row) {
                ...
                <tr>
                    <td class="type">
                        <a onclick=" window.location.href = 'build.php?gid=37&c=<?php echo $generator->getMapCheck($wref); ?>&del=<?php echo $wref; ?>'">
                            <img class="del" src="img/x.gif"> </a> <?php
                        switch ($type) {
                            case 1:
                            case 2:
                            case 3:
                    ...
                    <td class="coords">                        <?php
                        ...
                        echo $coor['y'];
                        ?>">                <span
                                    class="coordinates coordinatesWrapper coordinatesAligned coordinatesrtl">                <span
                                        class="coordinatesWrapper">              <span class="coordinateX">(<?php
                                        echo $coor['x'];
                                        ?></span>                <span class="coordinatePipe">|</span>                      <span
                                            class="coordinateY"><?php
                                        echo $coor['y'];
                                        ?>)</span>                </span></span> <span class="clear"></span></a></td>
                    <td class="res"><?php
                        echo $tt;
                        ?></td>
                </tr>            <?php
