		...
		<div class=\"information\">
                                        ...
                                        "dialog": {
                                            ...
                                            "data": {
                                                ...
                                                "defaultValues": {
                                                    ...
                                                    "nr": "1",
                                                    "btyp": "1",
                                                    "r1": <?=((${'ab' . $i}[$abdata['a' . $j] + 1]['wood']))?>,
                                                    "r2": <?=((${'ab' . $i}[$abdata['a' . $j] + 1]['clay']))?>,
                                                    "r3": <?=((${'ab' . $i}[$abdata['a' . $j] + 1]['iron']))?>,
                                                    "r4": <?=((${'ab' . $i}[$abdata['a' . $j] + 1]['crop']))?>,
                                                    "supply": "1",
                                                    "pzeit": 0,
                                                    "max1": 0,
                                                    "max2": 0,
            ...
            if (${'ab' . $i}[$abdata['a' . $j] + 1]['wood'] > $village->maxstore || ${'ab' . $i}[$abdata['a' . $j] + 1]['clay'] > $village->maxstore || ${'ab' . $i}[$abdata['a' . $j] + 1]['iron'] > $village->maxstore) {
                ...
                if ($village->getProd("crop") > 0) {
                    ...
                    echo "<span class=\"none\">Availability of necessary resources " . $time[0] . " في " . $time[1] . "</span>";
                } else {
                ...
                echo "<button type=\"button\" value=\"Upgrade level\" class=\"textButtonV3 green\" onclick=\"window.location.href = 'build.php?id=$id&amp;a=$j&amp;c=$session->mchecker'; return false;\">
                    <div class=\"button-container addHoverClick\">
                    <div class=\"button-background\">
                    <div class=\"buttonStart\">
                        <div class=\"buttonEnd\">
