<table cellpadding="1" cellspacing="1" id="build_value">
    <tr>
        ...
        <td>
            <b><?php echo $bid36[$village->resarray['f' . $id]]['attri'] * TRAPPER_CAPACITY; ?></b> <?php echo $lang['Build']['build36_06']; ?>
        </td>
    </tr>
    <tr>
        <?php
        ...
        if ($cur + $loop + $master > 0) {
            foreach ($building->buildArray as $bu) {
                echo "<tr class=\"underConstruction\"><th>Production at the level " . $bu['level'] . ":</th> <td><span class=\"number\">" . ${'bid' . $bu['type']}[$bu['level']]['attri'] * TRAPPER_CAPACITY . "</span> Traps </td></tr>";
            }
