<?php if ($session->gold > 2) {
    ...
    if (isset($_GET['c'])) {
        ...
        <p><b><?= market39 ?></b> <?= market40 ?> 3<img src="img/x.gif" class="gold" alt="Gold" title="Gold"/></p>
        <a href="javascript: history.go(-2);"><?= market41 ?></a>
    <?php } else { ?>
        ...
        <script language="JavaScript">
            ...
            function testSum() {
                if (document.getElementById("remain").innerHTML != 0) {
                    document.getElementById("submitText").innerHTML = "<a href='javascript:portionOut();'> <?=market42?></a>";
        ...
        <script language="JavaScript">var summe =<?php echo floor($village->awood + $village->acrop + $village->airon + $village->aclay); ?>;
        ...
        <form method="post" name="snd" action="build.php">
            ...
            <table id="npc" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td class="all">
                        <a href="javascript:fillup(0);"><i class="r1"></i></a>
                        <span id="org0"><?php echo floor($village->awood); ?></span>
                    </td>

                    <td class="all">
                        <a href="javascript:fillup(1);"><i class="r2"></i></a>
                        <span id="org1"><?php echo floor($village->aclay); ?></span>
                    </td>

                    <td class="all">
                        <a href="javascript:fillup(2);"><i class="r3"></i></a>
                        <span id="org2"><?php echo floor($village->airon); ?></span>
                    </td>

                    <td class="all">
                        <a href="javascript:fillup(3);"><i class="r4"></i></a>
                        <span id="org3"><?php echo floor($village->acrop); ?></span>
                    </td>

                    <td class="sum">Sum:&nbsp;<span
                ...
                <tr>
                    ...
                    <td class="sel">
                        <input class="text" onkeyup="calculateRest();" name="m2[]" size="5"
                               maxlength="7" <?php if (isset($_GET['r1'])) {
                            echo "value=\"" . $_GET['r1'] . "\"";
                        } ?>/>
                    ...
                    <td class="sel">
                        <input class="text" onkeyup="calculateRest();" name="m2[]" size="5"
                               maxlength="7" <?php if (isset($_GET['r2'])) {
                            echo "value=\"" . $_GET['r2'] . "\"";
                        } ?>/>
                    ...
                    <td class="sel">
                        <input class="text" onkeyup="calculateRest();" name="m2[]" size="5"
                               maxlength="7" <?php if (isset($_GET['r3'])) {
                            echo "value=\"" . $_GET['r3'] . "\"";
                        } ?>/>
                    ...
                    <td class="sel">
                        <input class="text" onkeyup="calculateRest();" name="m2[]" size="5"
                               maxlength="7" <?php if (isset($_GET['r4'])) {
                            echo "value=\"" . $_GET['r4'] . "\"";
                        } ?>/>
            ...
            <p id="submitButton">
                <?php if ($session->gold >= 3) { ?>
                    <a class="textButtonV3" href="javascript:document.snd.submit();">11111<?= market43 ?></a>
                    <span class="none">(<?= market40 ?>: <img src="img/x.gif" class="gold_g" alt="Gold" title="Gold"/><b>3</b>)</span>
                <?php } else {
                    echo "<span class='none'>" . market43 . "</span> (Costs: <img src='img/x.gif' class='gold' alt='Gold' title='Gold' /><b>3</b>)";
                } ?>    </p>
            <p id="submitText"></p>
        </form>
        <script>
