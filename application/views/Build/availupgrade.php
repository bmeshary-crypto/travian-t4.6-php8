...
<div id="contract_building<?php echo $i; ?>" class="contract contractNew contractWrapper">
    ...
    <div class="lineWrapper">
        <div class="inlineIcon duration"><i class="clock_medium"></i><span
                    class="value "><?php echo $generator->getTimeFormat($uprequire['time']); ?></span></div>
        ...
        if ($session->gold >= 3 && $building->getTypeLevel(17) >= 1 && $bindicator == 7) {
            ...
            ?>
            <button type="button" class="textButtonV3 gold exchange <?php echo $isDisabled ? 'disabled' : ''; ?>"
    ...
    <div class="contractLink">
        ...
        if ($bindicator == 2) {
            ...
            echo "<button type=\"button\" value=\"Upgrade level\" class=\"textButtonV3 green new\" onclick=\"window.location.href = 'dorf2.php?а=$i&id=$id&c=" . $session->checker . "'; return false;\">
...
<div class=\"button-background\">
    <div class=\"buttonStart\">
        ...
        if ($bindicator == 88 || $session->goldclub && $building->master == 0 && $bindicator < 8) {
            ...
            echo "<button type=\"button\" value=\"Upgrade level\" class=\"textButtonV3 gold\" onclick=\"window.location.href = 'dorf2.php?а=$i&id=$id&c=" . $session->checker . "'; return false;\">
<div class=\"button-container addHoverClick\" style=\"margin:1px -3px;\">
<div class=\"button-background\">
    <div class=\"buttonStart\">
        <div class=\"buttonEnd\">
