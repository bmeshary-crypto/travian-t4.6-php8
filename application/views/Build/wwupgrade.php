        ...
        if ($wwbuildingplan > $needed_plan) { // >
            ...
            if ($bindicate == 1) {
                ...
                if ($bindicate == 2) {
                    ...
                    echo "<span class=\"none\">Lack of food. Develop farms.</span>";
                } else if ($bindicate == 5) {
                    echo "<span class=\"none\">Develop Warehouse.</span>";
                } else if ($bindicate == 6) {
                    echo "<span class=\"none\">Develop the Barn.</span>";
                } else if ($bindicate == 7) {
                    $neededtime = $building->calculateAvaliable($id, $village->resarray['f' . $id . 't'], 1 + $loopsame + $doublebuild + $master);
                    if ($neededtime == 0) {
                        echo "<span class=\"none\">Sufficient resources Never</span>";
                    } else {
