<div id="build" class="gid16">
    ...
    if (isset($_GET['t']) && $_GET['t'] == 1){
        ...
        <table class="troop_details" cellpadding="1" cellspacing="1">
            <thead>
            <tr>
                <td class="role"><a href="karte.php?d=<?php echo $village->wid; ?>"><?php echo $village->vname; ?></a>
                </td>
                <td colspan="<?php if ($village->unitarray['u11'] == 0) {
                    echo "10";
                } else {
                    echo "11";
                } ?>">
        ...
        if (count($enforcetome) > 0) {
            foreach ($enforcetome as $enforce) {
                ...
                if ($enforce['from'] != 0) {
                    ...
                    $output .= "Troops of " . $info['username'];
        ...
        if (count($enforcetoyou) > 0) {
            ...
            foreach ($enforcetoyou as $enforce) {
                ...
                if ($vr && $fr) {
                    ...
                    echo 'No reinforced village found. Write to Admin ID ' . $enforce[$vr] . '<br /> Village with reinforce not found,please,write this id ' . $enforce[$vr] . ' to administrator';
                } else {
                    //     $info = $database->getUserVillInfoByVillageID($enforce['from']);
...
//$units_incoming += count($settlers);
    ...
    <div id="raidList">
        ...
        if (!$session->goldclub) {
            ?>
            <div class="build_desc"><p>Gold Club, allows you to hide the forces and smuggle them out of the village when
                    there are attacks on the village</p>
                <button type="button" class="gold builder textButtonV3" id="buttonjzlRVAnXm5wIW">
                    <div class="button-container addHoverClick">
                        ...
                        <div class="button-content">Gold Club</div>
                    </div>
                </button>
                        ...
                        if ($('buttonjzlRVAnXm5wIW')) {
                            $('buttonjzlRVAnXm5wIW').addEvent('click', function () {
                                window.fireEvent('buttonClicked', [this, {
                                    ...
                                    "value": "\u0646\u0627\u062f\u064a \u0627\u0644\u0630\u0647\u0628",
                                    "goldclubDialog": {
                                        "featureKey": "troopEscape",
                                        "infoIcon": "http:\/\/t4.answers.travian.com\/index.php?aid=Travian Answers#go2answer"
                                    },
                                    "title": "\u0627\u0644\u0647\u0631\u0648\u0628||\u0644\u0647\u0630\u0647 \u0627\u0644\u0645\u064a\u0632\u0629 \u062a\u062d\u062a\u0627\u062c \u0625\u0644\u0649 \u0646\u0627\u062f\u064a \u0627\u0644\u0630\u0647\u0628.",
                                    "id": "buttonjzlRVAnXm5wIW"
                                }]);
                            });
                        }
                    });
            ...
            <div class="options">
                ...
                if ($session->evasion == 1) {
                    ...
                    <input type="checkbox" class="check" name="hideShow"
                           onclick="window.location.href = '?id=39&t=100&disable';" checked="checked"> <?= build21 ?>
                    <?php
                } else {
                    ?>
                    <input type="checkbox" class="check" name="hideShow"
                           onclick="window.location.href = '?id=39&t=100&enable';"> <?= build21 ?>
                <?php } ?>
            </div>
