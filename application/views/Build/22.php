...
if ($building->getTypeLevel(22) > 0) {
    ...
    for ($i = $start, $x = 0; $i <= $end; $i++) {
		...
		<div class=\"clear\">&nbsp;</div>
                ...
                echo "<div class=\"contractLink\"><button type=\"button\"  class=\"textButtonV3 green\" onclick=\"window.location.href = 'build.php?id=$id&amp;a=$i&amp;c=" . $session->mchecker . "'; return false;\">
						<div class=\"button-container addHoverClick\">
							<div class=\"button-background\">
								<div class=\"buttonStart\">
									<div class=\"buttonEnd\">
