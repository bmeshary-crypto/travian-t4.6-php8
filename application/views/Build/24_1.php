...
if ($inuse > $time) {
    ...
    echo "<button type=\"button\" value=\"\" class=\"textButtonV3 green\" onclick=\"window.location.href = 'build.php?id=$id&type=1'; return false;\">
						<div class=\"button-container addHoverClick\">
  <div class=\"button-background\">
   <div class=\"buttonStart\">
    <div class=\"buttonEnd\">
...
<button type="button" class="gold exchange <?php echo $isDisabled ? 'disabled' : ''; ?>"
    ...
    <div class="button-container addHoverClick">
        ...
        if ($inuse > $time) {
            ...
            echo "
                	<button type=\"button\" value=\"\" class=\"textButtonV3 green\" onclick=\"window.location.href = 'build.php?id=$id&type=2'; return false;\">
						<div class=\"button-container addHoverClick\">
  <div class=\"button-background\">
   <div class=\"buttonStart\">
    <div class=\"buttonEnd\">
