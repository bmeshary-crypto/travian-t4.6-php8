...
<div class="boxes boxesColor gray traderCount">
    ...
    <div class="boxes-contents"><?= MERCHANTS ?>   <?php echo $market->merchantAvail(); ?>
        / <?php echo $market->merchant; ?></div>
</div>
<div class="clear"></div>
<?php
$checkexist = false;
    ...
    <form method="POST" name="snd" action="build.php?id=<?php echo $id; ?>&t=5">
        ...
        <table id="target_validate" class="res_target" cellpadding="1" cellspacing="1">
            ...
            <tr>
                ...
                ?>
                <td class="vil"><a
                            href="karte.php?d=<?php echo $getwref; ?>&c=<?php echo $generator->getMapCheck($getwref); ?>"><?php echo $getvilname; ?>
                        (<?php echo $getvilcoor['x']; ?>|<?php echo $getvilcoor['y']; ?>)<span class="clear"></span></a>
                </td>
            </tr>
            <tr>
                <th><?= OVERVIEW1 ?>:</th>
        ...
        <div class="clear"></div>
        <p>
            <button type="submit" value="ok" name="s1" id="btn_ok" class="green textButtonV3" tabindex="8">
                <div class="button-container addHoverClick">
                    ...
                    <div class="button-content"><?= market13 ?></div>
                </div>
            </button>
        </p>
    </form>
<?php } else {
    ...
    <form method="POST" name="snd" action="build.php?id=<?php echo $id; ?>&t=5">
            ...
            <tr>
                ...
                <td class="max LTR">&lrm;/
                    <a id="addRessourcesLink1" href="#"
                       onclick="marketPlace.addRessources(1);return false;"> <?php echo $market->maxcarry; ?></a>
                </td>

                <td class="val">
                    <input class="text" type="text" name="r1" id="r1" value="<?php echo $_POST['r1']; ?>" maxlength="20"
                           onchange="marketPlace.validateAndVisualizeMerchantCapacity(1)" tabindex="1">
                </td>
            ...
            <tr>
                ...
                <td class="max LTR">&lrm;/
                    <a id="addRessourcesLink2" href="#"
                       onclick="marketPlace.addRessources(2);return false;"> <?php echo $market->maxcarry; ?></a>
                </td>
                <td class="val">
                    <input class="text" type="text" name="r2" id="r2" value="<?php echo $_POST['r2']; ?>" maxlength="20"
                           onchange="marketPlace.validateAndVisualizeMerchantCapacity(2)" tabindex="2">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="max LTR">&lrm;/
                    <a id="addRessourcesLink3" href="#"
                       onclick="marketPlace.addRessources(3);return false;"> <?php echo $market->maxcarry; ?></a>
                </td>
                <td class="val">
                    <input class="text" type="text" name="r3" id="r3" value="<?php echo $_POST['r3']; ?>" maxlength="20"
                           onchange="marketPlace.validateAndVisualizeMerchantCapacity(3)" tabindex="3">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="max LTR">&lrm;/
                    <a id="addRessourcesLink4" href="#"
                       onclick="marketPlace.addRessources(4);return false;"><?php echo $market->maxcarry; ?></a>
                </td>
                <td class="val">
                    <input class="text" type="text" name="r4" id="r4" value="<?php echo $_POST['r4']; ?>" maxlength="20"
                           onchange="marketPlace.validateAndVisualizeMerchantCapacity(4)" tabindex="4">
                </td>
            </tr>
        ...
        <div class="destination">
                            ...
                            <td>
                                ...
                                <div class="coordinatesInput">
                                    ...
                                    <div class="yCoord">
                                        ...
                                        <input class="text coordinates x " type="text" name="x"
                                               value="<?= $coor['x'] ?>" maxlength="4" tabindex="7">
                                    </div>
                                    <div class="xCoord">
                                        <label for="xCoordInput">Y:</label>
                                        <input class="text coordinates y " type="text" name="y"
                                               value="<?= $coor['y'] ?>" maxlength="4" tabindex="6">
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                <div class="clear"></div>
            ...
            <?php if ($session->goldclub == 1) { ?>
                <p>Trade route <select class="markgos" name="send3">
        ...
        <div class="clear"></div>
        <p><?= market14 ?> <b><?php echo $market->maxcarry; ?></b> <?= market15 ?></p>
        <p>
        <div id="button">
            <div id="prepareError" class="error"></div>

            <button type="submit" value="send" id="enabledButton" class="green prepare textButtonV3"
    ...
    if (isset($_POST['ft']) == 'check') {
        ...
        if (!$checkexist) {
            $error = '<span class="error"><b>' . market16 . '</b></span>';
        } elseif ($getwref == $village->wid) {
            $error = '<span class="error"><b>' . market17 . '</b></span>';
        } elseif ($userAccess == '0' or $userAccess == '8' or $userAccess == '9') {
            $error = '<span class="error"><b>' . market18 . '</b></span>';
        } elseif ($_POST['r1'] == 0 && $_POST['r2'] == 0 && $_POST['r3'] == 0 && $_POST['r4'] == 0) {
            $error = '<span class="error"><b>' . market19 . '</b></span>';
        } elseif (!$_POST['x'] && !$_POST['y'] && !$_POST['dname']) {
            $error = '<span class="error"><b>' . market20 . '</b></span>';
        } elseif ($allres > $maxcarry) {
            $error = '<span class="error"><b>' . market21 . '</b></span>';
        }
        echo $error;
    }
    ?>
...
if (count($market->recieving) > 0) {
    ...
    foreach ($market->recieving as $recieve) {
        ...
        echo "</tr></thead><tbody><tr><th>" . market23 . "</th><td>";
        ...
        echo "</td></tr></tbody> <tr class=\"res\"> <th>" . market24 . "</th> <td colspan=\"2\"><span class=\"f10\">";
...
if (count($market->sending) > 0) {
    ...
    foreach ($market->sending as $send) {
        ...
        echo "<td><a href=\"karte.php?d=" . $send['to'] . "&c=" . $generator->getMapCheck($send['to']) . "\"> sends resources" . $database->getVillageField($send['to'], "name") . "</a> x" . ($send['send'] ? $send['send'] : '1') . "</td>";
        echo "</tr></thead> <tbody><tr> <th>" . market23 . "</th> <td>";
        ...
        echo "</td> </tr> <tr class=\"res\"> <th>" . market24 . "</th><td>";
...
if (count($market->return) > 0) {
    ...
    foreach ($market->return as $return) {
        ...
        echo "في " . $datetime[1] . "</div>";
        echo "</td> </tr> <tr class=\"res\"> <th>" . market24 . "</th>";
