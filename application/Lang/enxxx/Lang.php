<?php
	...
	define("BUILDING_TIMER","Bitirmek ");
	...
	define("SIDEINFO_HERO11","İyileşmek");
	define("SIDEINFO_HERO12","Deneyim");
	...
	define("INS92M","Kültür puanı miktarı:");
	define("INS93","High");
	define("INS94","Low");
	define("INS95","Quests");
	define("INS96","True");
	...
	define("INS109","Ana makinenizde büyük miktarda bellek RAM yeri yoksa,");
...
Arkadaşların yardımıyla / sahte IP'lerle yasaklanmış kayıt hesapları, <br/> bunun gibi hesaplar bulunacak ve cezalandırılacaksınız: <br/> Örneğin% 50 askerlerden. <br /> Dürüst olun ve vicdanlı olun adil oyna.");
	...
	define("B4","Tarla");
	define("B4_DESC","Nüfusunuzun yemeği burada üretiliyor. Çiftliğin seviyesini yükselterek mahsul üretimini arttırırsınız.");
	...
	define("QST15","Tren 100 adet ve Duvar seviyesi inşa <b>8</b>");
	...
	define("ARRIVING_REINF_TROOPS_SHORT","Dizgin.");
...
define("ACC14","Hesabınızı buradan silebilirsiniz. İptal işlemine başladıktan sonra hesabınızın iptalinin tamamlanması 24 saat sürer. Bu işlemi ilk 12 saat içinde iptal edebilirsiniz. Admistartion silmeyi iptal etmez.");
define("ACC15","Hesabı Silme?");
define("ACC16","Şifre girin:");
define("ACC17","Evet");
define("ACC18","Hayır");
define("ACC19","Sonra silme:");
define("ACC20","Bunlar için oturduğunuz hesaplar.");
define("ACC21","Bakıcı");
define("SAVE","Kaydetmek");
 //menu prof
define("PROFM1","Genel bakış");
...
define("STATISTIC5","İttifak bulunamadı");
define("STATISTIC6","Puan");
define("STATISTIC7","İttifaklar İstatistik(Kapalı)");
define("STATISTIC8","İttifaklar İstatistik(kesinlikle)");
define("STATISTIC9","Top");
define("STATISTIC10","Kahraman İstatistik");
define("STATISTIC11","Deneyim");
...
define("ALLIANCE8","İttifaktan at");
define("ALLIANCE9","İttifak Etkinlikleri");
define("ALLIANCE10","Etkinlik");
define("ALLIANCE11","Tarih");
define("ALLIANCE12","İttifaktan çıkmak için güvenlik nedeniyle şifrenizi tekrar girmeniz gerekir.");
define("ALLIANCE13","İttifak diplomasisi");
...
define("ALLIANCE18","İttifak açıklamasında bağlantıları otomatik olarak görmek istiyorsanız, yazın <span class=\"e\">[diplomatie]</span> açıklamaya, <span class=\"e\">[ally]</span>, <span class=\"e\">[nap]</span> ve <span class=\"e\">[war]</span> da mümkündür.");
...
define("ALLIANCE37","İttifakta çok fazla insan var");
define("ALLIANCE38","Alliance kurucusu");
define("ALLIANCE39","İttifak tarafından kuruldu");
...
define("ALLIANCE51","İttifak mevcut değil");
//crop finder or nice place for ddos,lol
define("FINDER1","Burada mahsul vahaları olan 9 ve 15 mahsul tarlalarına sahip köyleri arayabilirsiniz.");
...
$lang['desc'][ 1 ] = array ( 0 => 'Oduncu, kereste üretmek için ağaçları keser. Teklifi ne kadar uzatırsanız1 o kadar çok kereste üretir.');
$lang['desc'][ 2 ] = array ( 0 => 'Tuğla burada üretilir. Seviyesini artırarak kil üretimini arttırırsınız.');
$lang['desc'][ 3 ] = array ( 0 => 'Burada madenciler değerli demir kaynağı üretirler. Madenin seviyesini yükselterek demir üretimini arttırırsınız.');
$lang['desc'][ 4 ] = array ( 0 => 'Nüfusunuzun yemeği burada üretiliyor. Çiftliğin seviyesini yükselterek mahsul üretimini arttırırsınız.');
$lang['desc'][ 5 ] = array ( 0 => 'Değirmende daha fazla odun işleniyor. Bitkinin gelişme düzeyine bağlı olarak odun imalatı ve yüzde 25 oranında artırılabilmektedir.');
$lang['desc'][ 6 ] = array ( 0 => 'Brickyardda kilden tuğlalar üretiyor. Bir tuğla fabrikasının seviyesi nedeniyle kil imalatı ve yüzde 25 oranında artırılabilmektedir.');
$lang['desc'][ 7 ] = array ( 0 => 'Demir fabrikasında demir üretimi gerçekleşir. Demir fabrikasının gelişme düzeyi ile ilişkili demir üretimi ve yüzde 25 oranında artırılabilir.');
...
$lang['desc'][ 10 ] = array ( 0 => 'Odun, kil ve demir kaynakları deponuzda saklanır. Seviyesini yükselterek depo kapasitenizi artırırsınız.');
$lang['desc'][ 11 ] = array ( 0 => 'Buğday tarlalarından elde edilen buğday, tahıl ambarında saklanır. Seviye ne kadar yüksek olursa, depolama kapasitesi o kadar büyük olur.');
$lang['desc'][ 12 ] = array ( 0 => 'Eriticide daha iyi silah savaşçılar uydurabilir. Binanın gelişmesiyle birlikte silahların maksimum iyileştirme seviyesi artar.');
...
$lang['desc'][ 15 ] = array ( 0 => 'Köyün mimarları ana binada yaşıyor. Seviye ne kadar yüksek olursa, diğer binalar o kadar hızlı inşa edilecek veya yükseltilecektir.');
$lang['desc'][ 16 ] = array ( 0 => 'Köy Askerleri miting noktasında buluşuyor. Buradan onları başka bir köyü Destek etmek, Saldırı yapmak veya fethetmek için gönderebilirsiniz.');
...
$lang['desc'][ 18 ] = array ( 0 => 'Büyükelçilik, diplomatik ilişkilerin yeridir. 1. seviyede bir ittifaka katılabilirken, 3. seviye bir elçiliğe sahipseniz kendiniz bile bulabilirsiniz.') ;
$lang['desc'][ 19 ] = array ( 0 => 'Kışlada piyade eğitimli Askerler olabilir. Kışlanın gelişmesiyle birlikte askerlerin eğitim süresi azaldı. ');
$lang['desc'][ 20 ] = array ( 0 => 'Ahırlar, tüm süvari Askerleri eğitilebilir. İstikrarlı eğitim süresi askerlerin geliştirilmesi ile. ');
$lang['desc'][ 21 ] = array ( 0 => 'Stüdyoda mancınık ve koçan gibi kuşatma silahları oluşturabilirsiniz. Atölyenin gelişmesiyle üretim süresi kısaldı. ');
$lang['desc'][ 22 ] = array ( 0 => 'Akademi, yeni asker türleri keşfedilebilir. Akademi Gelişme ile birlik türlerinin incelenmesi için mevcut miktarı artırır. ');
$lang['desc'][ 23 ] = array ( 0 => 'Depodan hammadde önbelleğinde saklanan sakinlerinin köyüne Saldırı yaparsanız. Bu hammaddeler saldırganlar tarafından çalınamaz. ');
$lang['desc'][ 24 ] = array ( 0 => 'Salonda sakinleri için muhteşem tatiller düzenleyebilirsiniz. , böylece kültür birimi sayınız artar. ');
$lang['desc'][ 25 ] = array ( 0 => 'İkamet, kral veya kraliçenin köyü ziyaret ettiğinde yaşadığı küçük bir saraydır. Köşk, köyü fethetmek isteyen düşmanlara karşı korur. ');
...
$lang['desc'][ 27 ] = array ( 0 => 'İmparatorluğunuzun hazinesinde depolanan hazineler. Her hazinenin bir eser için yeri vardır. Ayrıca, yapının etkisi, yakalandıktan sonra ancak 24 saat (normal bir sunucu için) veya 12: 00 den (yüksek hızlı sunucu için) sonra etkinleştirilecektir. ');
$lang['desc'][ 28 ] = array ( 0 => 'Ticaret Odasında güçlü yetiştirilmiş at arabalarının ve atların performansını artırabilir. Ticaret Odasının gelişmesiyle birlikte, bir tüccar taşıyabilen maksimum hammadde miktarı artmaktadır. ');
...
$lang['desc'][ 30 ] = array ( 0 => 'Büyük Ahır süvari trenine izin verir. Ancak eğitimin maliyeti üç kat daha fazladır. en istikrarlı başkentte inşa edemez. ');
$lang['desc'][ 31 ] = array ( 0 => 'sur, köyü saldırılardan korur. duvarın seviyesi ne kadar yüksekse, köyünüzün savunması sırasında koruması o kadar etkili olur. ');
$lang['desc'][ 32 ] = array ( 0 => 'Duvar, köyünüzü saldırılardan korur. duvar daha yüksekse, köyü rakiplerinizin Saldırılarından ve saldırılarından korumak o kadar kolay olur. ');
$lang['desc'][ 33 ] = array ( 0 => 'Duvar, köyünüzü saldırılardan korur. duvar daha yüksekse, köyü rakiplerinizin Saldırılarından ve saldırılarından korumak o kadar kolay olur. ');
$lang['desc'][ 34 ] = array ( 0 => 'taş ustası, taşların işlenmesi ile ilgili işlerde uzmandır. Binanın gelişmesiyle birlikte köydeki tüm binaların sağlamlığı artar. ');
...
$lang['desc'][36]=array(0=>"Tuzakçı, köyünüzü iyi gizli tuzaklarla korur. Düşmanlar hapsedilebilir ve artık köyünüze zarar veremez. Tuzaklara hapsedilen askerler, aslen ait oldukları köyün mahsulünü yerler.");
...
$lang['desc'][ 41 ] = array ( 0 => 'Teşekkürler atlarınızı sulamak daha iyi hisseder ve böylece atlı askerleri öğrenmeyi hızlandırır ve onlar tarafından tüketilen tahıl miktarını azaltır. ');
...
define ("NGZ2", "Mevcut inşaat süresi");
define ("NGZ3", "Seviye inşaat süresi");
...
define ("dvrc8", "Şifre:");
define ("dvrc9", "Ad");
define ("dvrc10", "Miktar");
define ("dvrc11", "Maks");

//POSOLbSTVO
define ("posl0", "İttifak");
define ("posl1", "Etiket");
define ("posl2", "Ad");
...
define ("RE1", "Konut, kralın ziyaret ettiği sırada yaşadığı küçük bir saraydır. Köşk, köyü düşman güçleri tarafından fethedilmekten korur.");
...
define ("RE25", "Yakında");
define ("RE26", "Tren");
define ("RE27", "Yeni bir köy kurmak için seviye 10 veya 20 konut ve 3 yerleşimciye ihtiyacınız var. Yeni bir köyü fethetmek için seviye 10 veya 20 konut ve bir senatör, şef veya şefe ihtiyacınız var." );
...
define ("gz1", "Artık bir binaya ihtiyacınız yoksa, binanın yıkımını sipariş edebilirsiniz.");
define ("gz2", "Yıkım");
define ("gz3", "Bu köydeki tüm inşaat ve araştırma siparişlerini 2 Altın karşılığında hemen bitirilsin mi?");
define ("gz4", "Binayı yok et");
...
define ("ratusha5", "Mahsul üretimi negatiftir, böylece gerekli kaynaklara asla ulaşamazsınız");
...
//ARENA
define ("AR", "Turnuva Kare Seviyesi");
define ("AR1", "Turnuva meydanında, Askerleriniz dayanıklılıklarını artırabilir. Seviye ne kadar yüksekse, Askerleriniz 30 alandan daha uzakta olduklarında o kadar hızlı hareket eder.");
define ("AR2", "");
define ("AR3", "");
define ("AR4", "");

//MASTERSKAI
define ("MA", "Kuşatma Atölyesi Seviyesi");
define ("MA1", "Mancınık ve koç gibi kuşatma silahları kuşatma atölyesinde üretilmektedir. Seviye ne kadar yüksekse, birimler o kadar hızlı üretilir.");
define ("MA2", "");
define ("MA3", "");
define ("MA4", "");

//PEKARNIA
define ("PE", "Fırın Seviyesi");
define ("PE1", "Fırında, değirmenden gelen un fırınlanarak ekmek haline getirilir. Değirmenle birlikte fırın buğday üretimini yüzde 50'ye kadar artırabilir.");
define ("PE2", "");
define ("PE3", "");
define ("PE4", "");

//RATYSHA
define ("RAT", "Belediye Binası Seviyesi");
define ("RAT1", "Belediye binasında vatandaşlarınız için abartılı partiler düzenleyebilirsiniz. Bu partiler kültür puanınızı artırır.");
define ("RAT2", "");
define ("RAT3", "");
define ("RAT4", "");
...
define ("VO1", "At içme teknesi atlarınızın sağlığına önem verir, mahsul tüketimini azaltır ve eğitimlerini hızlandırır. Seviye başına, ahırınızdaki eğitim süresi kısalır.");
define ("VO2", "");
define ("VO3", "");
define ("VO4", "");
...
define ("BIG1", "Harika kışlalar aynı anda daha fazla birim inşa etmenize izin verir, ancak orijinal miktarın üç katına mal olurlar. ");
define ("BIG2", "");
define ("BIG3", "");
define ("BIG4", "");
...
define ("KONI1", "Büyük ahır, aynı anda daha fazla birim oluşturmanıza izin verir, ancak orijinal miktarın üç katı maliyeti vardır.");
define ("KONI2", "");
define ("KONI3", "");
define ("KONI4", "");
...
//KYZNIZA
define ("KZ", "Demirci Seviyesi");
define ("KZ1", "Demircinin eritme fırınlarında, savaşçılarınızın silahları geliştirilir. Seviyesini yükselterek, daha da iyi silahların imal edilmesini sipariş edebilirsiniz.");
define ("KZ2", "Yükselt");
define ("KZ3", "Demirci");
define ("KZ4", "Eylem");
...
define ("IEFF0", "+% 15 daha fazla deneyim.");
define ("ITEM1", "Aydınlanma Miğferi");
define ("IEFF1", "+% 20 daha fazla deneyim.");
define ("ITEM2", "Bilgelik Miğferi");
define ("IEFF2", "+% 25 daha fazla deneyim.");
...
define ("IEFF33", "İttifak üyeleri arasında% 15 daha hızlı asker");
define ("ITEM34", "Standart");
define ("IEFF34", "İttifak üyeleri arasında% 20 daha hızlı asker");
define ("ITEM35", "Büyük Standart");
define ("IEFF35", "İttifak üyeleri arasında% 25 daha hızlı asker");
...
define ("IEFF105", "kahraman 10'a İstiflenebilir deneyim verir");
...
define ("IEFF110", "Anında CP miktarını verir, günlük üretime eşit, ancak 5000'den fazla İstiflenebilir");
define("ITEM111","");
define("IEFF111","");
define("ITEM112","");
define("IEFF112","");
...
define ("HEROI32", "seviyeye ulaşma deneyimi");
define ("HEROI33", "Deneyim:");
...
define ("PRODUCTION_PROD_S1", "Kil Ocağı Seviyesi");
...
define ("dorf1_villageNameBox_5", "Kararlı değil");
define ("dorf1_villageNameBox_6", "Kararlı inşa");
...
define ("dorf1_villageNameBox_12", "Kararlıya git");
...
define ("LVL", 'level');
define("SIDE_I_1","Eserler çıkacakv");
define("SIDE_I_2","");
...
define("UPGRADECOST","Seviyeye yükseltme maliyetleri %s ");
...
Depo depolama ve Mahsul, çiftliklerde eşittir. <br>
Liste, her öğenin oluşturulma zamanına göre sıralanır.<br>
</small>");
define("PROTECTION_TIME","Koruma Süreniz <span class=\"timer\" counting=\"down\" value=\"%s\">%s</span>");
define("ACCOUNT_DELETION","Hesabınız silinecek <b><span class=\"timer\" counting=\"down\" value=\"%s\">%s</span></b>");
define("Ally_dorf1","İttifak");
...
define ("first_desc4", "İlk travian deneyiminizse, Galyalılara tavsiye ederiz");
...
define ("first_Teutons_desc5", "Agresif ve deneyimli oyuncular için.");
...
define ("JR_CONSTRUCTION_PLANS_RELEASE_MYTHS_DESC", "Ne yazık ki, hiç kimse - bilge ve deneyimli bile - bu planların nerede bulunabileceği hakkında hiçbir fikre sahip değil. Ne kadar çok insan bulmaya çalışırsa, o kadar çok efsane gibi görünüyordu.");
...
define ("JR_HEROEXP", "deneyim");
define ("JR_HEROEXPGROW", "deneyim kazancı");
define ("JR_HEROEXPWILLBE", "kullanımdan sonra deneyim olacaktır");
...
define("pluss15","Değiştirmek istediğiniz Altın veya Gümüş miktarını girin.");
...
define("changepos4", "İttifak Diplomasisi");
...
define ("build7", "Demirciyi geliştirin");
...
define ("build14", "Artık bir binaya ihtiyacınız yoksa, binanın yıkım emrini verebilirsiniz");
...
define ("build21", "başkentiniz için asker kaçırmayı etkinleştirin.");
...
define ("build164", "Mahsul üretimi negatiftir, böylece gerekli kaynaklara asla ulaşamazsınız");
...
define ("build203", "on");
define ("build204", "Tren");
define ("build205", "Yeni bir köy kurmak için seviye 10 veya 20 konut ve 3 yerleşimciye ihtiyacınız var. Yeni bir köyü fethetmek için seviye 10 veya 20 konut ve bir senatör, şef veya şefe ihtiyacınız var." );
...
define ("build384", "Mevcut kararlılık bonusu");
...
define("plus13", "Farklı bir miktar için altın satın almak(UnitPay) (TR)");
define("plus14", "Ödeme miktarı");
...
define("plus65", "Değiştirmek istediğiniz Altın veya Gümüş miktarını girin");
...
define ("sokr7", "Hazine");
define ("sokr8", "lvl");
define ("sokr9", "Yakalanmış");
define ("sokr10", "Yapınız");
define ("sokr11", "İsim");
define ("sokr12", "Yapıtınız yok.");
define ("sokr13", "En yakın eserler");
define ("sokr14", "Oyuncu");
define ("sokr15", "Mesafe");
define ("sokr16", "En yakın eserler eksik.");
define ("sokr17", "Hazine");
define ("sokr18", "Küçük artefakt");
define ("sokr19", "Hiç yapı yok.");
define ("sokr20", "Büyük eserler");
...
define ("ww8", "WW 50+ seviyesini inşa etmek için 2 yapı planına ihtiyacınız var (biri siz ve ikincisi İttifakınızdan olmalı !!!)");
define ("ww9", "WW9'u inşa etmek için hesabınızda ilk bina planına ihtiyacınız var veya / ve (50+ seviye) ikinci bina planında İttifakınızdan bir arkadaşınız olmalıdır!");

// kuznicaupgrade
define ("kuzupg0", "Tamamen Geliştirilmiş");
define ("kuzupg1", "Demirciyi geliştirin");
...
define ("questday13", "+ 1 gün +% 25 mahsul üretimi");
...
define ("questday31", "Herhangi bir birimi Smithy'de maksimum seviyeye yükseltin");
...
define ("REP_С16", "");
define ("REP_С17", "Konut veya Saray yok edilmemiş");
...
define ("quest2", "Eğitim sırasında, zaten bir maceradan bazı deneyimler topladınız. Bir sonraki maceraya kahramanınız köyünüze döner dönmez başlayın. Ganimet ve tecrübe daha hızlı büyümenizi sağlayacaktır.");
define ("quest3", "İkinci maceraya geç");
define ("quest4", "30 kahraman deneyimi");
...
define ("quest42", "Kışlalarınızı 3. seviyeye yükseltin");
...
define ("quest52", "Demirci inşa et");
define ("quest53", "Bir demirci, askerlerinizi daha iyi silahlandırmanıza ve donatmanıza izin verir. Ayrıca, ek birlik binaları inşa etmek için bir demirci gerekir.");
define ("quest54", "Demirci inşa et.");
...
define ("quest58", "Demircilikte bir birim gelişimini araştırın.");
...
define ("quest66", "Bir kereste, kil, demir ve mahsul alanını her birini 1. seviyeye genişletin. Bu görevi tamamlamak için 0. seviyenin üzerindeki her kaynak türünden en az 2 alana sahip olmanız gerekir. Travian PLUS hala aktif olduğu sürece , her zaman aynı anda bir inşaat daha sipariş edebilirsiniz. ");
define ("quest67", "Her kaynak karosundan bir tane daha 1. seviyeye uzatın");
define ("quest68", "Tebrikler! Köyünüz büyür ve büyür ...");
define ("quest69", "Tahıl ambarı");
define ("quest70", "Daha fazla mahsul depolamak için, bir tahıl ambarına ihtiyacınız var. Mevcut depolama limitiniz, kaynaklar çubuğuna bakıldığında bulunabilir.");
define ("quest71", "Bir tahıl ambarı inşa et");
define ("quest72", "Harika! Tahıl ambarı artık daha fazla mahsul depolamanıza izin veriyor.");
define ("quest73", "Hepsi bir arada");
define ("quest74", "Başlangıçta, kaynaklara odaklanmak en iyisidir. Lütfen tüm kaynak alanlarınızı 1. seviyeye yükseltin.");
...
define ("quest77", "2'ye!");
define ("quest78", "Üretiminizi artırmaya devam edin. Bir kereste, kil, demir ve mahsul tarlasını her birini 2. seviyeye yükseltin!");
define ("quest79", "Bir kaynak alanını her birini 2. seviyeye yükselt");
...
define ("quest105", "Artık daha fazla inşaat için çok sayıda ücretsiz mahsulünüz var. Diğer kaynakların üretimini artıran binalar da var.");
define ("quest106", "Tümü 5'e");
define ("quest107", "İkinci bir köy için gerekli bina ve yerleşimcileri karşılayana kadar uzun bekleme süresinden tasarruf etmek için çok daha yüksek bir üretime ihtiyacınız olacak. Tüm kaynak alanlarını 5. seviyeye yükseltin.");
...
define ("quest122", "Ana binanızı 3. seviyeye yükseltin");
...
define ("quest146", "Ana binanızı 5. seviyeye yükseltin");
define ("quest147", "Harika, şimdi bir konut inşa edebilirsiniz. Çalışanlarınızın hızı da arttı.");
...
define ("quest150", "Bir konut veya saray inşa edin.");
define ("quest151", "Bu bina, yeni bir köy kurmak veya fethetmek için gereklidir. Seviyesi olası genişletme miktarını sınırlar.");
define ("quest152", "Kültür noktaları");
define ("quest153", "İmparatorluğunuzda daha fazla köyde hüküm sürmek için kültür puanlarına ihtiyacınız vardır. Konut veya saraydaki genel bakış size ne kadar uzakta olduğunuzu ve ne kadar süreceğini söyler.");
define ("quest154", "Evinizdeki veya sarayınızdaki kültür puanları sekmesini açın.");
define("quest155","Köy listesinde, olası yeni köylerin mevcut durumunu ve eksik kültür puanlarının miktarını da görebilirsiniz. Visit \"Answers\" kültür puanlarınızı nasıl hızlı bir şekilde artırabileceğinizi öğrenmek için.");
...
define ("quest158", "Deponuzu 7. seviyeye yükseltin");
...
define ("quest160", "Konut veya saray seviyesi 10");
define("quest161","Yerleşimciler bir sarayda veya bir konutta eğitilebilir. Sekme \"Train\" size gerekli bina seviyesini gösterir.");
define ("quest162", "Evinizi veya sarayınızı 10. seviyeye yükseltin");
...
define("new_village2","`s köy");
	...
	$lang_winner ['5'] = 'İttifakla birlikte';
...
'12' => 'Puanlar'
	...
	$lang['quests'] = array(
		...
		'2' => array(
			...
			'reward' => '1. seviye bir Kil çukuru sizi bekliyor!',
			'completed' => 'Artık mevcut göreviniz hakkında her zaman bilgi alabilirsiniz. Taks ödülü aldığınızda sonraki göreve başlayabilirsiniz. kil ocağınızı alın.'
		),
		...
		'5' => array(
			'Title' => 'Tarla İnşa Et',
			'Description' => 'Kaynaklarının payına baktığınızda sol köşedeki buğday tüketimine dikkat edin. Askerleri ve binaları eğitmek için bu miktar gereklidir. Lütfen bir Tarla yapın.',
			'toDo' => array('Tarla Tarlası ',' Tarla Tarlası inşa et 1. seviyeye tıklayın'),
			'reward' => 'Tarla 1. seviyeyi bitir ve 2. seviyeye yükselt',
			'completed' => 'Artık köyünüzün buğdayı, yeni bir bina inşa etmeye yetecek miktarda üretiliyor. Nüfuslar yerel olarak buğday köyünde konuşlanmış beslenme güçleri destekleniyor.'
		),
		...
		'9' => array(
			'Title' => 'Askeri	Üs',
			'Description' => 'kahramanınızı maceralara göndermek için bir toplanma noktasına ihtiyacınız var - onu köy merkezinde bulabilirsiniz! İnşa edin ve 1. seviyeye yükseltin.',
		...
		'11' => array(
			...
			'Description' => 'Deneyim ve değerli ganimetler toplamak için çevrenizdeki gizemli yerleri keşfedin. Macera listesini açın ve kahramanınızı ilk macerasına gönderin.',
...
'toDo' => array ('Rapor Listesini Aç', 'Yeni macera raporunu görüntüle'),
		...
		'13' => array(
			...
			'Description' => 'Kahramanınız hafif yaralandı. Resmine tıklayarak kahramanın genel görünümünü açın. Şimdi envanterdeki merhemlere tıklayın ve "tamam" ile kullanın. Sadece gerekli miktar kullanılacaktır.',
			'toDo' => array('Envanteri açmak için kahramanınızın resmine tıklayın ',' Bunları kullanmak için envanterdeki merhemlere tıklayın'),
			'reward' => 'Ek olarak, Kahramanınız '.number_format(20*SPEED).' deneyim puanları.',
...
$lang['quests']['battle'] = array(
	'1' => array(
		...
		'Description' => 'Eğitim sırasında, zaten bir maceradan bazı deneyimler topladınız. Kahramanınız köyünüze döner dönmez bir sonraki maceraya başlayın. Yağma ve tecrübe daha hızlı büyümeni sağlayacak.',
		'toDo' => array('İkinci maceraya geçin'),
		'reward' => ''.number_format(30*SPEED).' kahraman deneyimi',
	...
	'10' => array(
		...
		'toDo' => array('Kışlalarınızı 3. seviyeye yükseltin'),
	...
	'14' => array(
		...
		'completed' => 'Demircide bir birim iyileştirme araştırın!'
	),
);
...
$lang['quests']['economy'] = array(
	...
	'2' => array(
		...
		'Description' => 'Bir kereste, kil, demir ve mahsul tarlasını her birini 1. seviyeye uzatın. Bu görevi tamamlamak için 0. seviyenin üzerindeki her kaynak türünden en az 2 alana sahip olmanız gerekir. Travian PLUS hala aktif olduğu sürece, her zaman bir tane daha sipariş edebilirsiniz. aynı zamanda inşaat.',
		'toDo' => array('Her kaynak karosundan bir tane daha 1. seviyeye uzatın'),
	...
	'3' => array(
		'Title' => 'Tahıl ambarı',
		'Description' => 'Daha fazla mahsul depolamak için bir tahıl ambarına ihtiyacınız var. Mevcut depolama sınırınız, kaynaklar çubuğuna bakıldığında bulunabilir.',
		...
		'completed' => 'Güzel yapılmış! Tahıl ambarı artık daha fazla mahsul depolamanıza izin veriyor.'
	),
	'4' => array(
		'Title' => 'Hepsi bir arada',
		'Description' => 'Başlangıçta en iyisi kaynaklara odaklanmaktır. Lütfen tüm kaynak alanlarınızı 1. seviyeye yükseltin.',
		'toDo' => array('Tüm kaynak alanlarını 1. seviyeye yükseltin'),
	...
	'5' => array(
		...
		'toDo' => array('Her kaynağın 1 alanını 2. seviyeye yükseltin'),
	...
	'8' => array(
		'Title' => 'Hepsi 2 ye',
		'Description' => 'Daha pahalı binalar inşa etmeye başlamadan önce, kaynak üretiminizi daha da artırmalıyız. Tüm kaynak alanlarınızı 2. seviyeye yükseltin.',
	...
	'9' => array(
		...
		'toDo' => array('Deponuzu 3. seviyeye yükseltin'),
	...
	'10' => array(
		...
		'toDo' => array('Tahıl ambarınızı 3. seviyeye yükseltin'),
	...
	'11' => array(
		...
		'toDo' => array('Bir ekili alanı 1. seviyeye yükseltin'),
		'reward' => 'Tahıl Değirmeni Seviye 2',

		'completed' => 'Artık daha fazla inşaat için çok sayıda ücretsiz mahsulünüz var. Diğer kaynakların üretimini artıran binalar da var.'
	),
	'12' => array(
		'Title' => 'Hepsi 5 e',
		'Description' => 'İkinci bir köy için ihtiyaç duyulan bina ve yerleşimcileri karşılayana kadar uzun bir bekleme süresinden tasarruf etmek için çok daha yüksek bir üretime ihtiyacınız olacak. Tüm kaynak alanlarını 5. seviyeye yükseltin.',
		'toDo' => array('Tüm kaynak alanlarını 5. seviyeye yükseltin'),
		'reward' => 'Tüm kaynakların üretiminde 1 gün +% 25 bonus',
...
$lang['quests']['world'] = array(
	...
	'3' => array(
		...
		'toDo' => array('Ana binayı 3. seviyeye yükseltin'),
	...
	'9' => array(
		...
		'toDo' => array('Ana binanızı 5. seviyeye yükseltin'),
	...
	'10' => array(
		...
		'Description' => 'Yakında yeni bir köy kurmak için hemen bir hükümet merkezi inşa edin. Bu köyün başkent köyünüz olarak kalmasını isteyip istemediğinizden emin değilseniz, lütfen konutu seçin.',
		...
		'completed' => 'Bu bina yeni bir köy kurmak ya da fethetmek için gereklidir. Seviyesi, olası genişletme miktarını sınırlar.'
	),
	'11' => array(
		'Title' => 'Kültür noktaları',
		'Description' => 'İmparatorluğunuzdaki daha fazla köyde hüküm sürmek için kültür puanlarına ihtiyacınız var. Konut veya saraydaki genel bakış size ne kadar uzakta olduğunuzu ve bunun ne kadar süreceğini söyler.',
		'toDo' => array('Konutunuzdaki veya sarayınızdaki kültür puanları sekmesini açın'),
		...
		'completed' => 'Köy listesinde, olası yeni köylerin mevcut durumunu ve eksik kültür puanlarının miktarını da görebilirsiniz. Kültür puanlarınızı nasıl hızlı bir şekilde artırabileceğinizi öğrenmek için \ "Answers \" bölümünü ziyaret edin.'
	),
	'12' => array(
	...
	'13' => array(
		'Title' => 'Konut veya saray seviyesi 10',
		'Description' => 'Yerleşimciler bir sarayda veya bir konutta eğitilebilir. "Eğitim" sekmesi size gerekli bina seviyesini gösterir.',
		'toDo' => array('Evinizi veya sarayınızı 10. seviyeye yükseltin'),
...
'5' => array ('Açık Mahsul Arazisi', 'Mahsul Arazisi İnşa Et'),
...
'11' => 'Kültür puanları',
'12' => 'Depo seviyesi 7',
'13' => 'Konut veya saray seviyesi 10',
'14' => '3 Yerleşimci',
'15' => 'Yeni köy',
);
...
This is your new home.<br><br>

Take a look around. The lush fields, the golden crop and the iron mountains - they all belong to you. Your village may be small right now, but with enough wit and hard work, you will transform it into an empire. Still, a great ruler needs more than virtue – a great ruler needs wisdom. So hear me out:<br><br>

The world revolves around resources. Your buildings need them, your troops eat them, and whole wars will be waged over nothing else. Yet, it’s important that you understand: Resources are a means to an end. Spend them, always. Your beginner’s protection will fade after 5 days and raiders won`t wait long. Play frequently and invest in the Cranny and more resource fields to keep a thriving economy.<br><br>

Take a deep breath. The air may still be fresh from the rain, but there`s a hint of ash. You cannot escape the signs of war. But the art of diplomacy needs no longer be a secret: Speak to others. Find friends and join an alliance. They will support you in times of need and provide you with countless advice. You should also write to your aggressors. You will find that a deal can often be made that benefits you both.<br><br>

Now lay the first stone. This is your monument. But it won’t be the only one. Your plan should be to settle a second village as soon as you can. Your options and therefore your power will increase greatly. Plenty more resources, additional ways to specialize with buildings and hence better strategies. Settling closer to your friends is also a benefit that should not be ignored.<br><br>

No more words should be wasted. It is time for action. Consult the Taskmaster – he has great plans for you already. Let me finish with one invaluable piece of wisdom: You have never truly lost until you have given up. There will be challenges and there will be setbacks, though only through overcoming those will you grow. Every great story involves some hardship. Now go out there and show the world what you are made of.',
...
<br> <br>
İnşaat için, mucizenin sahibi 49. seviyeye kadar bir bina planı edinmeli, ittifaktan başka bir oyuncu mucizeyi 100. seviyeye yükseltmeye devam etmek için başka bir bina planına sahip olmalıdır.',
	);
...
$lang['quests']['achievements'] = array(
	...
	'5' => array(
		...
		'Description' => 'Bu görevin puanlarını elde etmek için ya altın kazanmalı ya da harcamalısınız. Altın bakiyenizin herhangi bir miktarını nasıl ve ne için kazanmak / kullanmak istediğinize karar vermek size kalmıştır. <br> <br> Bu görevin puanları günde 3 kez elde edilebilir.',
