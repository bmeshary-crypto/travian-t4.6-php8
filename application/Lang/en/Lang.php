...
define("exchange0", "Silver converter");
define("exchange1", "Exchange");
define("exchange2", "You don't have enough gold");
define("exchange3", "You don't have enough silver");
define("exchange4", "No gold specified for exchange");
define("exchange5", "Gold transfer");
define("exchange6", "You don't have enough gold");
define("exchange7", "Silver converter");
define("exchange8", "Exchange silver for gold now");
define("exchange9", "Go through");
define("exchange10", "adventures to open an auction!");
...
define("STATISTIC38", "Village");
define("STATISTIC39", "Rewards");
define("STATISTIC40", "Villages");
//alliance
...
define("rpts7", "sends resources to");
...
define("questday23", "(Next reset at 18:00 o'clock. Make sure to collect your reward before!)");
...
define("REP_С2", "Residence/Palace");
...
define("REP_С29", "Delivered reinforcement to");
...
define("REP_С37", "Spies");
define("REP_С38", "Received resources from");
define("REP_С39", "Delivered resources to");
define("REP_С40", "destroyed");
define("REP_С41", "wasn't damaged");
define("REP_С42", "The loyalty was lowered from");
define("REP_С43", "Animals captured");
define("REP_С44", "");
...
$lang['Msgs'] = array(
	...
	<li> Send attack(not raid) on village with artifact  </li>
	<li> You need to win the battle </li>
	<li> To destroy treasury which holds the artifact </li>
	<li> Hero must be present at this battle in order to collect artifact </li>
	<li> Treasury level required: 10 </li>
	<br> <br>
	So then go get your artefact! If the attack succeeds and the artefacts is stolen, a special ability will be activated upon arrtiving to your treasury!
	<br> <br>
	To build World Wonder up to level 49 you need to own a building plan, to continue building your Wolrd Wonder above 49th level your alliance friend will need to own a second building plan to build you World Wonder up to the 100th level!');
