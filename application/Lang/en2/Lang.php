<?php
	...
	define("SIDEINFO_ALLIANCE","Aliança");
	define("SIDEINFO_ALLY_FORUM","Fórum da Aliança");
	...
	define("PLUS24","Completar todas as construções e pesquisas");
	define("PLUS25","Complete");
	define("PLUS26","Comprar");
...
define("HEROI38","Campos por hora");
...
define("ACCOUNT_DELETION","Your account will be deleted in <b><span class=\"timer\" counting=\"down\" value=\"%s\">%s</span></b>");
...
$lang['Msgs'] = array(
	...
	right">
					<br><br>
					The time has come to reclaim the artefacts. Conspire with your alliance and assemble your warriors to retrieve these coveted objects. However, the Natars will not give the artefacts up without a fight… and neither shall your enemies. If you can manage to successfully repossess the artefacts and fend off your enemies, then you will be able to reap the rewards. Your buildings shall become incredibly strong and powerful, your troops much faster and more crop-efficient. Seize the artefacts, bring glory to your empire, and become the new legends for your successors</p><br><br>
	<span style="font-size:60%; color: #666;">(Written by : الصياد)</span>
	</center>
	</div>',
