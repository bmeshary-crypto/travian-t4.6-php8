...
$lang['News'] = array(
    ...
    'Arts' => '<li>Artifacts will be released in <span class="timer" counting="down" value="%s">%s</span> hours</li>',
    'WWPlans' => '<li>Construction plans will appear in <span class="timer" counting="down" value="%s">%s</span> hours</li>',
);