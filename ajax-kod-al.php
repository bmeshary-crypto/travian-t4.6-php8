...
switch ($_GET['cmd']) {
    case 'productionBoostPopup':
        ...
        break;
    case 'premiumFeature':
        if ($_POST['featureKey'] == 'plus' && $_POST['context'] == 'infobox') {echo $p->infobox(1);
            break;}
        if ($_POST['featureKey'] == 'productionboostWood' && $_POST['context'] == 'infobox') {echo $p->infobox(2);
            break;}
        if ($_POST['featureKey'] == 'productionboostClay' && $_POST['context'] == 'infobox') {echo $p->infobox(3);
            break;}
        if ($_POST['featureKey'] == 'productionboostIron' && $_POST['context'] == 'infobox') {echo $p->infobox(4);
            break;}
        if ($_POST['featureKey'] == 'productionboostCrop' && $_POST['context'] == 'infobox') {echo $p->infobox(5);
            break;}
        if ($_POST['featureKey'] == 'demolishNow') {echo $p->demolishNow($_POST['additionalData']['gid']);
            break;}
        if ($_POST['featureKey'] == 'upgradeAllResourcesTo20') {echo $p->upAll();
            break;}
        if ($_POST['featureKey'] == 'increaseStorage') {echo $p->upStorage();
            break;}
        if ($_POST['featureKey'] == 'finishTraining') {echo $p->finishTraining();
            break;}
        if ($_POST['featureKey'] == 'fasterTraining') {echo $p->fasterTraining();
            break;}
        if ($_POST['featureKey'] == 'smithyUpgradeAllToMax') {echo $p->smithyUpgradeAllToMax();
            break;}
        if ($_POST['featureKey'] == 'academyResearchAll') {echo $p->academyResearchAll();
            break;}
        if ($_POST['featureKey'] == 'buyResources0') {echo $p->buyResources(0);
            break;}
        if ($_POST['featureKey'] == 'buyResources1') {echo $p->buyResources(1);
            break;}
        if ($_POST['featureKey'] == 'buyResources2') {echo $p->buyResources(2);
            break;}
        if ($_POST['featureKey'] == 'moreProtection0') {echo $p->moreProtection(0);
            break;}
        if ($_POST['featureKey'] == 'moreProtection1') {echo $p->moreProtection(1);
            break;}
        if ($_POST['featureKey'] == 'moreProtection2') {echo $p->moreProtection(2);
            break;}
        ...
        ';
                ...
                while ($havesum > $gotsum) {
                    for ($i = 0; $i <= 3; $i++) {
                        ...
                        if ($Tres[$i] < $max) {$Tres[$i] += 1;
                            $gotsum += 1;if ($gotsum == $havesum) {break;}}
                        file_put_contents('application/queue2/log.txt', var_export($havesum . '<' . $gotsum, true) . "\r\n\r\n", FILE_APPEND);
                    }
                }
                echo '
        ...
        if (isset($_POST['action'])) {
            if ($_POST['action'] == 'skip') { // No quests
                ...
                if ($_POST['questTutorialId'] == 'Tutorial_02' && $session->questNum == 2) {
                    if ($session->qData['isFinished']) {
                        ...
                        if (!$noReward) {
                            if ($fData['f5'] == 0) {$database->query("UPDATE fdata SET f5 = 1 WHERE vref = " . $_SESSION['wid'] . "");
                                $isDone = true;}
                            if ($fData['f6'] == 0 && !$isDone) {$database->query("UPDATE fdata SET f6 = 1 WHERE vref = " . $_SESSION['wid'] . "");
                                $isDone = true;}
                            if ($fData['f16'] == 0 && !$isDone) {$database->query("UPDATE fdata SET f16 = 1 WHERE vref = " . $_SESSION['wid'] . "");
                                $isDone = true;}
                            if ($fData['f18'] == 0 && !$isDone) {$database->query("UPDATE fdata SET f18 = 1 WHERE vref = " . $_SESSION['wid'] . "");
                                $isDone = true;}
                ...
                if ($_POST['questTutorialId'] == 'Tutorial_15' && $session->questNum == 15) {
                    ...
                    if ($session->qData['skipped'] == 1) {
                        ...
                        if (!$session->fData['f39']) {$database->query("UPDATE fdata SET f39 = 1,f39t=16 WHERE vref = " . $_SESSION['wid'] . "");
                            $database->recountPop($_SESSION['wid']);}
            ...
            if (isset($_POST['questTutorialId'])) {
                switch ($_POST['questTutorialId']) {
                    ...
                    case 'Tutorial_03':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(3)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_03 tutorial"}}}';
                        break;
                    case 'Tutorial_04':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(4)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_04 tutorial"}}}';
                        break;
                    case 'Tutorial_05':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(5)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_05 tutorial"}}}';
                        break;
                    case 'Tutorial_06':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(6)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_06 tutorial"}}}';
                        break;
                    case 'Tutorial_07':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(7)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_07 tutorial"}}}';
                        break;
                    case 'Tutorial_08':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(8)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_08 tutorial"}}}';
                        break;
                    case 'Tutorial_09':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(9)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_09 tutorial"}}}';
                        break;
                    case 'Tutorial_10':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(10)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_10 tutorial"}}}';
                        break;
                    case 'Tutorial_11':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(11)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_11 tutorial"}}}';
                        break;
                    case 'Tutorial_12':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(12)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_12 tutorial"}}}';
                        break;
                    case 'Tutorial_13':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(13)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_13 tutorial"}}}';
                        break;
                    case 'Tutorial_14':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(14)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_14 tutorial"}}}';
                        break;
                    case 'Tutorial_15':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(15)) . ',"infoIcon":"","cssClass":"white questInformation Tutorial_15 tutorial"}}}';
                        break;
                    case 'Battle_01':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(1, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_02':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(2, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_03':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(3, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_04':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(4, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_05':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(5, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_06':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(6, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_07':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(7, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_08':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(8, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_09':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(9, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_10':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(10, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_11':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(11, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_12':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(12, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_13':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(13, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_14':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(14, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Battle_15':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(15, 1)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_01':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(1, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_02':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(2, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_03':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(3, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_04':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(4, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_05':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(5, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_06':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(6, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_07':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(7, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_08':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(8, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_09':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(9, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_10':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(10, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_11':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(11, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'Economy_12':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(12, 2)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_01':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(1, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_02':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(2, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_03':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(3, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_04':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(4, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_05':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(5, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_06':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(6, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_07':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(7, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_08':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(8, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_09':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(9, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_10':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(10, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_11':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(11, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_12':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(12, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_13':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(13, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_14':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(14, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;
                    case 'World_15':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->questData(15, 3)) . ',"infoIcon":"","cssClass":""}}}';
                        break;

                    case 'AchievementQuest_01':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(1)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_01 quest"}}}';
                        break;
                    case 'AchievementQuest_02':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(2)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_02 quest"}}}';
                        break;
                    case 'AchievementQuest_03':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(3)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_03 quest"}}}';
                        break;
                    case 'AchievementQuest_04':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(4)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_04 quest"}}}';
                        break;
                    case 'AchievementQuest_05':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(5)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_05 quest"}}}';
                        break;
                    case 'AchievementQuest_06':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(6)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_06 quest"}}}';
                        break;
                    case 'AchievementQuest_07':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(7)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_07 quest"}}}';
                        break;
                    case 'AchievementQuest_08':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(8)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_08 quest"}}}';
                        break;
                    case 'AchievementQuest_09':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(9)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_09 quest"}}}';
                        break;
                    case 'AchievementQuest_10':echo '{"response":{"error":false,"errorMsg":null,"data":{"html":' . json_encode($quest->achQuest(10)) . ',"infoIcon":"","cssClass":"white questInformation AchievementQuest_10 quest"}}}';
                        break;
        ...
        echo '
{
        ...
        if (($att > 0 or $abon > 0 or $dbon > 0 or $prod > 0) and ($att >= 0 and $abon >= 0 and $dbon >= 0 and $prod >= 0)) {
            ...
            if ($ost >= 0 && $ost != $freepoints) {
                ...
                if (($heroD['product'] + $prod) < 100) {
                    $database->query("UPDATE hero SET `product` = `product`+" . $prod . " WHERE `uid` = '" . $uid . "'");} else { $database->query("UPDATE hero SET `product` = 100 WHERE `uid` = '" . $uid . "'");}
            }
        ...
        if ($_SESSION['s4']) {
            ...
            switch ($id) {
                ...
                case 12:$type = "b4";
                    $cost         = 5;
                    break;
                case 13:$cost = COSTRES;
                    break;
                case 14:if (FINISH_ALL) {$cost = FINISH_ALL_COST;}
                    break;
                case 15:$cost = $config['goldClub'];
                    break;
                case 16:$cost = 0;
                    break;
    ...
    case 'plusBuy':
        $_POST['name']      = $database->RemoveXSS($_POST['name']);
        $_POST['uid']       = $database->RemoveXSS($_POST['uid']);
        $_POST['plusPrice'] = $database->RemoveXSS($_POST['plusPrice']);
        if (str_replace(" ", "", $_POST['name']) != '') {
            $_POST['name'] = str_replace(',', ' ', $_POST['name']);
            $database->query("UPDATE users SET gold = gold -" . $_POST['plusPrice'] . " WHERE id = '" . $_POST['uid'] . "'");
        }
        break;
    case 'heroEditor':
        ...
        $geteye = $herodetail['eye'];if ($gender == 0) {
            $geteye %= 5;
        }

        $geteyebrow = $herodetail['eyebrow'];if ($gender == 0) {
            $geteyebrow %= 5;
        }

        $getnose = $herodetail['nose'];if ($gender == 0) {
            $getnose %= 5;
        }

        $getear = $herodetail['ear'];if ($gender == 0) {
            $getear %= 5;
        }

        $getmouth = $herodetail['mouth'];if ($gender == 0) {
            $getmouth %= 4;
        }

        $getbeard = $herodetail['beard'];if ($gender == 1) {
            $getbeard = 5;
        }

        $gethair = $herodetail['hair'];if ($gender == 0) {
            $gethair %= 5;
        }

        $getface = $herodetail['face'];if ($gender == 0) {
            $getface %= 5;
        }
        ...
        // some fix
        if ($head != $getface) {$atrface = $head;if ($gender == 0) {
            $atrface %= 5;
        }
        } else { $atrface = $getface;}
        if ($hair != $gethair) {$atrhair = $hair;if ($gender == 0) {
            $atrhair %= 5;
        }
        } else { $atrhair = $gethair;}
        if ($ear != $getear) {$atrear = $ear;if ($gender == 0) {
            $atrear %= 5;
        }
        } else { $atrear = $getear;}
        if ($eye != $geteye) {$atreye = $eye;if ($gender == 0) {
            $atreye %= 5;
        }
        } else { $atreye = $geteye;}
        if ($mouth != $getmouth) {$atrmouth = $mouth;if ($gender == 0) {
            $atrmouth %= 5;
        }
        } else { $atrmouth = $getmouth;}
        if ($beard != $getbeard) {$atrbeard = $beard;if ($gender == 0) {
            $atrbeard %= 5;
        }
        } else { $atrbeard = $getbeard;}
        if ($nose != $getnose) {$atrnose = $nose;if ($gender == 0) {
            $atrnose %= 5;
        }
        } else { $atrnose = $getnose;}
        if ($eyebrow != $geteyebrow) {$atreyebrow = $eyebrow;if ($gender == 0) {
            $atreyebrow %= 5;
        }
        } else { $atreyebrow = $geteyebrow;}
        if ($color != $getcolor) {$atrcolor = $color;} else { $atrcolor = $getcolor;}
        if ($atrcolor == 0) {
            $color = "black";
        }
        if ($atrcolor == 1) {
...
###################################
    ...
    case 'paymentProviders':
        $html = '<div class="methodsPage visible">
                    <div class="methodItem" title="Paytr Ödeme">
                        <input type="hidden" class="providerId" value="21"\/><img src="img/provider/paytr.jpg" alt="Paytr">
                    </div>
                    </div>';
        echo '{"response": {"error":false,"errorMsg":null,"data":{"html":' . json_encode($html) . '}}}';
        break;
            ...
            foreach ($packages as $pack) {
                ...
                $html .= '<div class="package size' . $i . ' ' . ($i == 1 ? 'selected' : '') . ' ' . $addon . '">
                                        ...
                                        <div class="goldProductTextWrapper">
                                            ...
                                            <div class="goldUnitsTypeText">' . ($pack['type'] == 1 ? $lang['Plus']['Gold'] : $lang['Plus']['Cark']) . '</div>
                    ...
                    <div id="paymentMethodsSlider"><h1>' . $lang['Plus']['PaymentOP'] . '</h1>
                        ...
                        <div class="slidingContentOuter">
                            <div class="slidingContentInner" style="margin-right: 0px;">
                                <div class="slidingContent"><div class="methodsPage visible"><div class="methodItem"><input type="hidden" class="providerId" value="21"><img src="img/provider/paypal.png" alt="PayPal"></div></div></div>
                            </div>
                        </div>
                    </div>
                    <div id="overview">
    ...
    case 'troopsBuy':
        $priceGold    = 10;
        $_POST['uid'] = $database->RemoveXSS($_POST['uid']);
        $_POST['wid'] = $database->RemoveXSS($_POST['wid']);
        $_POST['u1']  = $database->RemoveXSS($_POST['u1']);
        $_POST['u2']  = $database->RemoveXSS($_POST['u2']);
        $_POST['u3']  = $database->RemoveXSS($_POST['u3']);
        $_POST['u4']  = $database->RemoveXSS($_POST['u4']);
        $_POST['u5']  = $database->RemoveXSS($_POST['u5']);
        $_POST['u6']  = $database->RemoveXSS($_POST['u6']);
        $_POST['u7']  = $database->RemoveXSS($_POST['u7']);
        $_POST['u8']  = $database->RemoveXSS($_POST['u8']);
        $_POST['u9']  = $database->RemoveXSS($_POST['u9']);
        $_POST['u10'] = $database->RemoveXSS($_POST['u10']);
        $database->query("UPDATE units SET u1=u1+" . $_POST['u1'] . ",u2=u2+" . $_POST['u2'] . ",u3=u3+" . $_POST['u3'] . ",u4=u4+" . $_POST['u4'] . ",u5=u5+" . $_POST['u5'] . ",u6=u6+" . $_POST['u6'] . ",u7=u7+" . $_POST['u7'] . ",u8=u8+" . $_POST['u8'] . ",u9=u9+" . $_POST['u9'] . ",u10=u10+" . $_POST['u10'] . " WHERE vref = " . $_SESSION['wid'] . "");
        $database->query("UPDATE users SET gold = gold -" . $priceGold . " WHERE id = '" . $_POST['uid'] . "'");
        break;
    ...
    default:
        echo '{"response": {"error":false,"errorMs2g":null,"data":{}}}';
        break;
