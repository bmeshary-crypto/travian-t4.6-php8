    ...
    <div id="troops">
        ...
        <div class="contentNavi tabNavi ">
            <div title="" class="container category1 active">
                ...
                <div class="content"><a id="buttonN1" onclick="showTroops(1)"" class="tabItem"><?php echo TRIBE1; ?></a>
                </div>
            </div>
            <div title="" class="container category2 normal">
                <div class="background-start">&nbsp;</div>
                <div class="background-end">&nbsp;</div>
                <div class="content"><a id="buttonC2" onclick="showTroops(2)"" class="tabItem"><?php echo TRIBE2; ?></a>
                </div>
            </div>
            <div title="" class="container category3 normal">
                <div class="background-start">&nbsp;</div>
                <div class="background-end">&nbsp;</div>
                <div class="content"><a id="buttonQ3" onclick="showTroops(3)"" class="tabItem"><?php echo TRIBE3; ?></a>
                </div>
            ...
            <div title="" class="container category6 normal">
                <div class="background-start">&nbsp;</div>
                <div class="background-end">&nbsp;</div>
                <div class="content"><a id="buttonc4" onclick="showTroops(6)"" class="tabItem"><?php echo TRIBE6; ?></a>
                </div>
            </div>
            <div title="" class="container category7 normal">
                <div class="background-start">&nbsp;</div>
                <div class="background-end">&nbsp;</div>
                <div class="content"><a id="buttonh5" onclick="showTroops(7)"" class="tabItem"><?php echo TRIBE7; ?></a>
                </div>
            </div>
            <div class="clear"></div>
        </div>
        <ul class="troops1"><?php for ($i = 1; $i <= 10; $i++) {
                echo '<li><img src="img/x.gif" class="unit u' . $i . '"><a href="manual.php?typ=1&amp;s=' . $i . '">' . constant('U' . $i) . '</a></li>';
            } ?></ul>
        <ul class="troops2 hide"><?php for ($i = 11; $i <= 20; $i++) {
                echo '<li><img src="img/x.gif" class="unit u' . $i . '"><a href="manual.php?typ=1&amp;s=' . $i . '">' . constant('U' . $i) . '</a></li>';
            } ?></ul>
        <ul class="troops3 hide"><?php for ($i = 21; $i <= 30; $i++) {
                echo '<li><img src="img/x.gif" class="unit u' . $i . '"><a href="manual.php?typ=1&amp;s=' . $i . '">' . constant('U' . $i) . '</a></li>';
            } ?></ul>
    ...
    <div id="buildings">
        ...
        <div class="contentNavi tabNavi ">
            ...
            <div title="" class="container category1 active">
                <div class="background-start">&nbsp;</div>
                <div class="background-end">&nbsp;</div>
                <div class="content"><a id="buttonu6" onclick="showBuildings(1)""
                    class="tabItem"><?php echo $lang['Manual']['Building1']; ?></a></div>
            </div>
            <div title="" class="container category2 normal">
                <div class="background-start">&nbsp;</div>
                <div class="background-end">&nbsp;</div>
                <div class="content"><a id="buttons7" onclick="showBuildings(2)""
                    class="tabItem"><?php echo $lang['Manual']['Building2']; ?></a></div>
            </div>
            <div title="" class="container category3 normal">
                <div class="background-start">&nbsp;</div>
                <div class="background-end">&nbsp;</div>
                <div class="content"><a id="buttonv8" onclick="showBuildings(3)""
                    class="tabItem"><?php echo $lang['Manual']['Building3']; ?></a></div>
            </div>
        </div>
